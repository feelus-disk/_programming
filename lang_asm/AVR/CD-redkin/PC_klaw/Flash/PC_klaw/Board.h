...
// Объявление функции инициализации внешних прерываний
extern void irq_pio_init ( void );

//Объявление функции-обработчика внешнего прерывания IRQ1
