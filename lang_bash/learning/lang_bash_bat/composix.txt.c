...
source          выполняет команды из файла в текущей среде (без запуска отдельного shell'а)
...
-s выводить только суммарный объем (в Кб)
-h выводить удобный для человека объем
}
