      ...
      integer iborn,iqed,iew,iqcd,gfscheme,ifgg,its,igzm2,ilin,ichep,irun
...
C AS: moved scales to scales.h header
C      real*8 thmu,thmu2,tlmu,tlmu2,omega 
      real*8 s,t,u,qs,ts,us,mf,mf1,spr
      real*8 nc,fc,cfl,cfq,cfscheme,cfprime
     ...
     & zmzzzfer,zmwzwfer,zmhzhfer,deltarhofer,tadfer
      ...
      real*8 ddilog
      real*8 theta_hard
      complex*16 jaa,jaz,jav,javsub
      complex*16 d040,d040wz,tdd0
      complex*16 b0p,b0f,b0d1,b0d2,b0dw,bff,c0_sp,c01,c0ir,c0irf
      complex*16 xspenz,jinteg
      complex*16 jazzsub,jawsub
      complex*16 c000,c0analys
      complex*16 jaw_tbud_subsub1,jaw_tbud_subsub2
      complex*16 jaw_udtb_subsub1,jaw_udtb_subsub2
      complex*16 jaw_butd_subsub1,jaw_butd_subsub2
     ...
     & vpatn,vmatn,vpata,vmata,vpatp,vmatp,vpabt,vmabt,dfen,dfel,dfup,
     & dfdn,dfmn,dfmo,dfch,dfst,dftn,dfta,dftp,dfbt
      common/flags/iborn,iqed,iew,iqcd,gfscheme,ilin,ifgg,its,irun
      common/comphep/ichep
      common/ff/ffarray
      common/qfi3f/qf,i3f,rmf1
      common/nc/nc,fc,cfl,cfq,cfscheme,cfprime
...
C      common/scales/thmu2,tlmu2,omega
