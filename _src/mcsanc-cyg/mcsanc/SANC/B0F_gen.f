...
*
      IMPLICIT NONE
      REAL*8 MU2,Q2,ABQ2,DRM12,DRM22,RU,RD,B0FEXP
      COMPLEX*16 M12,M22,SQR,SQS,ILQ
*
      ABQ2=DABS(Q2)
...
*
* B0F(Q2;MU2,0,0)
       IF(DRM12.LT.1D-14.AND.DRM22.LT.1D-14) THEN
        IF(Q2.LT.0D0) THEN
         B0F=2D0-LOG(Q2/MU2*DCMPLX(1D0,-DIMAG(M12)))
        ELSE
         B0F=2D0-LOG(Q2/MU2)
        ENDIF
        RETURN
