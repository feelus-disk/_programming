...
************************************************************************
* File (nc-qcd_br_14_23__14_16_16.f) is created on Wed Apr 18 13:38:50 MSK 2012.
*****************************************************************************
* This is the FORTRAN module (nc_qcd_ha_14_23__14_16_16_1spr) to calculate
* differential cross-section for the gluon induced anti-dn + g -> anti-dn + mo^+ + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
*****************************************************************************
      subroutine nc_qcd_ha_14_23__14_16_16_1spr (s,spr,hard)
      implicit none!
     ...
     & +v0spr*betasprmomo**3*log(1d0/mdn**2*s)*((s-spr)**2+spr**2)*alpha
     & **2*alphas*cf*(1d0/48/s**3/spr)
     & +v0spr*betasprmomo*log(1-1d0/s*spr)*((s-spr)**2+spr**2)*alpha**2*
     & alphas*cf*(1d0/8/s**3/spr)
     & +v0spr*betasprmomo*log(1d0/mdn**2*s)*((s-spr)**2+spr**2)*alpha**2
     ...
     & +vaspr*betasprmomo*log(1d0/mdn**2*s)*((s-spr)**2+spr**2)*alpha**2
