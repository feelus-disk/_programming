...
************************************************************************
* File (nc_ha_1414_1212.f) is created on Wed Apr 18 13:30:37 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_ha_1414_1212) to calculate differential
* hard photon Bremsstrahlung for the anti-dn + dn -> el^+ + el^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_ha_1414_1212 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
      ...
      real*8 betasdndn,ibetasdndn,betasprelel,ibetasprelel
     ...
     & +(chizs*chizsprc+chizsc*chizspr)*a2z
      ...
      v2sspr =
     & +2d0*qdn**2*qel**2
     & +qdn*qel*(chizs+chizsc+chizspr+chizsprc)*v1z
