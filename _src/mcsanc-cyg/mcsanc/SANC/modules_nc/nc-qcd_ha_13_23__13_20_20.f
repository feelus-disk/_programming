...
************************************************************************
* File (nc-qcd_ha_13_23__13_20_20.f) is created on Wed Apr 18 13:40:40 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_13_23__13_20_20) to calculate
* differential cross-section of the gluon induced
* anti-up + g -> anti-up + ta^+ + ta^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_13_23__13_20_20 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & costh5/s**2)
      ...
      hard=
     & +v0spr*iz1up**2*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*
     & (-1d0/8*p1p3*p2p4*mup**2/s**2-1d0/8*p1p4*p2p3*mup**2/s**2+1d0/8*p
     & 2p3*p4p5*mup**2/s**2+1d0/8*p2p4*p3p5*mup**2/s**2)
     & +v0spr*iz1up*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(-1
     ...
     & +a0spr*iz1up**2*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*
     & (1d0/8*p1p3*p2p4*mup**2/s**2-1d0/8*p1p4*p2p3*mup**2/s**2+1d0/8*p2
     & p3*p4p5*mup**2/s**2-1d0/8*p2p4*p3p5*mup**2/s**2)
     & +a0spr*iz1up*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(1d
     ...
     & *p1p4*p3p5/s**3)
     & +vaspr*iz1up**2*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*
     & (1d0/8*p1p2*mup**2*mta**2/s**2-1d0/8*p2p5*mup**2*mta**2/s**2)
     & +vaspr*iz1up*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(1d
