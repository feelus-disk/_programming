...
************************************************************************
* File (nc_si_1313_1212.f) is created on Wed Apr 18 13:09:42 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_si_1313_1212) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_si_1313_1212 (s,t,u,sigma)
      implicit none!
     ...
     & 0d0
      ...
      amp(1,2,1,2) =
     & +ffgg*(-qel*qup+costhel*qel*qup)
     & +ffqq*(-chizs*vmael*vmaup+chizs*costhel*vmael*vmaup)
     & +fflq*(-2*chizs*aup*vmael+2*chizs*costhel*aup*vmael)

      amp(1,2,2,1) =
     & +ffgg*(-qel*qup-costhel*qel*qup)
     & +ffqq*(-chizs*vmael*vmaup-chizs*costhel*vmael*vmaup)
     & +ffll*(-4*chizs*ael*aup-4*chizs*costhel*ael*aup)
     & +fflq*(-2*chizs*aup*vmael-2*chizs*costhel*aup*vmael)
     & +ffql*(-2*chizs*ael*vmaup-2*chizs*costhel*ael*vmaup)
