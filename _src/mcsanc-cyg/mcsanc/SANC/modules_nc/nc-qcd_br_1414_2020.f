...
************************************************************************
* File (nc-qcd_br_1414_2020.f) is created on Wed Apr 18 13:35:46 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_br_1414_2020) to calculate EW Born
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_br_1414_2020 (qs,ts,us,born,soft,hard)
      implicit none!
...
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_1414_2020_1spr) to calculate hard
* gluon radiation for the anti-dn + dn -> ta^+ + ta^- process.
*
* It is produced by s2n package of SANC (v1.10) Project.
* Copyright (C), SANC Project Team, 2002-2012.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_1414_2020_1spr (s,spr,hard)
      implicit none!
      include 's2n_declare.h'
     ...
     & +chizspr*chizsprc*vaz
      ...
      hard=
     & +ln1sdn*v0spr*betasprtata*(s**2+spr**2)*alpha**2*alphas*cf*(1d0/3
     & /s**2/spr/(s-spr)*theta_hard(s,spr,omega))
     & +ln1sdn*v0spr*betasprtata**3*(s**2+spr**2)*alpha**2*alphas*cf*(1d
     & 0/9/s**2/spr/(s-spr)*theta_hard(s,spr,omega))
     & +ln1sdn*vaspr*betasprtata*(s**2+spr**2)*alpha**2*alphas*cf*(4d0/3
