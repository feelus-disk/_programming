...
************************************************************************
* File (nc-qcd_br_23_14__14_16_16.f) is created on Wed Apr 18 13:38:36 MSK 2012.
*****************************************************************************
* This is the FORTRAN module (nc_qcd_ha_23_14__14_16_16_1spr) to calculate
* differential cross-section for the gluon induced g + dn -> dn + mo^+ + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
*****************************************************************************
      subroutine nc_qcd_ha_23_14__14_16_16_1spr (s,spr,hard)
      implicit none!
