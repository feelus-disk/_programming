...
************************************************************************
* File (nc-qcd_ha_23_13__13_12_12.f) is created on Wed Apr 18 13:39:31 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_23_13__13_12_12) to calculate
* differential cross-section of the gluon induced
* g + up -> up + el^+ + el^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_23_13__13_12_12 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & 3+1d0/16*p1p3*p4p5/s**3-1d0/16*p1p4*p2p3/s**3-1d0/16*p1p4*p3p5/s*
     & *3)
     & +a0spr*iz1up/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(-1d0/4*p1p2*p1
     & p3*p2p4/s**3-1d0/8*p1p2*p1p3*p4p5/s**3+1d0/4*p1p2*p1p4*p2p3/s**3+
     & 1d0/8*p1p2*p1p4*p3p5/s**3-1d0/8*p1p2*p2p3*p4p5/s**3+1d0/8*p1p2*p2
