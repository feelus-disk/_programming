...
************************************************************************
* File (nc-qcd_ha_23_14__14_20_20.f) is created on Wed Apr 18 13:41:48 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_23_14__14_20_20) to calculate
* differential cross-section of the gluon induced
* g + dn -> dn + ta^+ + ta^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_23_14__14_20_20 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & (-1d0/8*p1p3*p2p4*mdn**2/s**2+1d0/8*p1p4*p2p3*mdn**2/s**2-1d0/8*p
     & 2p3*p4p5*mdn**2/s**2+1d0/8*p2p4*p3p5*mdn**2/s**2)
     & +a0spr*iz1dn*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(-1
     & d0/4*p1p2*p1p3*p2p4/s**3-1d0/8*p1p2*p1p3*p4p5/s**3+1d0/4*p1p2*p1p
     & 4*p2p3/s**3+1d0/8*p1p2*p1p4*p3p5/s**3-1d0/8*p1p2*p2p3*p4p5/s**3+1
