...
************************************************************************
* File (nc_si_1414_1616.f) is created on Wed Apr 18 13:10:28 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_si_1414_1616) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_si_1414_1616 (s,t,u,sigma)
      implicit none!
     ...
     & 0d0
      ...
      amp(1,2,1,1) =
     & +ffgg*(-2*sinthmo*1d0/sqrt(s)*qdn*qmo*mmo)
     & +ffqq*(-2*chizs*sinthmo*1d0/sqrt(s)*vmadn*vmamo*mmo)
     & +ffll*(-4*chizs*sinthmo*1d0/sqrt(s)*adn*amo*mmo)
     & +fflq*(-4*chizs*sinthmo*1d0/sqrt(s)*adn*vmamo*mmo)
     & +ffql*(-2*chizs*sinthmo*1d0/sqrt(s)*vmadn*amo*mmo)
     & +ffld*(-2*chizs*sinthmo*1d0/sqrt(s)*pxsmomo*adn*amo*mmo)
     & +ffqd*(-chizs*sinthmo*1d0/sqrt(s)*pxsmomo*vmadn*amo*mmo)

      amp(1,2,1,2) =
     & +ffgg*(-qdn*qmo+costhmo*qdn*qmo)
     & +ffqq*(-chizs*vmadn*vmamo+chizs*costhmo*vmadn*vmamo)
     & +ffll*(-2*chizs*adn*amo+2*chizs*costhmo*adn*amo-2*chizs*costhmo*1
     & d0/sqrt(s)*sqrtpxsmomo*adn*amo+2*chizs*1d0/sqrt(s)*sqrtpxsmomo*ad
     & n*amo)
     & +fflq*(-2*chizs*adn*vmamo+2*chizs*costhmo*adn*vmamo)
     & +ffql*(-chizs*vmadn*amo+chizs*costhmo*vmadn*amo-chizs*costhmo*1d0
     & /sqrt(s)*sqrtpxsmomo*vmadn*amo+chizs*1d0/sqrt(s)*sqrtpxsmomo*vmad
     & n*amo)
