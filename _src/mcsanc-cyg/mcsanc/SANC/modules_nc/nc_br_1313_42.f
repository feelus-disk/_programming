...
************************************************************************
* File (nc_br_1313_42.f) created on Wed Apr 18 13:48:13 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_bo_1313_42) to calculate EW
* integrated Born cross section for the anti-up + up -> H + Z process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_bo_1313_42 (s,born)
      implicit none!
...
************************************************************************
* This is the FORTRAN module (nc_br_1313_42) to calculate EW Born
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_br_1313_42 (qs,ts,us,born,soft,hard)
      implicit none!
      include 's2n_declare.h'
     ...
     & 2*mh**2/s**2+1d0/3072*mz**4/s**2)
      ...
      softvirt=
     & +born/pi*alpha*qup**2*(-1d0/2)
     & +born/pi*alpha*qup**2*(l2-1)*(3d0/2)
     & +log(2*omega/sq)*born/pi*alpha*qup**2*(l2-1)*(2)
     & +ddilog(1d0)*born/pi*alpha*qup**2*(2)
...
************************************************************************
* This is the FORTRAN module (nc_ha_1313_42_1spr) to calculate hard
* photon Bremsstrahlung for the anti-up + up -> H + Z process.
*
* It is produced by s2n package of SANC (v1.10) Project.
* Copyright (C), SANC Project Team, 2002-2012.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_ha_1313_42_1spr (s,spr,hard)
      implicit none!
      include 's2n_declare.h'
     ...
     & g**6*stw**2/ctw**4*qup**2/s**2/(s-spr)*theta_hard(s,spr,omega)*(l
