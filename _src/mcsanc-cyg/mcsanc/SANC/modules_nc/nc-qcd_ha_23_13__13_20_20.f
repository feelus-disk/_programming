...
************************************************************************
* File (nc-qcd_ha_23_13__13_20_20.f) is created on Wed Apr 18 13:40:26 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_23_13__13_20_20) to calculate
* differential cross-section of the gluon induced
* g + up -> up + ta^+ + ta^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_23_13__13_20_20 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & (-1d0/8*p1p3*p2p4*mup**2/s**2+1d0/8*p1p4*p2p3*mup**2/s**2-1d0/8*p
     & 2p3*p4p5*mup**2/s**2+1d0/8*p2p4*p3p5*mup**2/s**2)
     & +a0spr*iz1up*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(-1
     & d0/4*p1p2*p1p3*p2p4/s**3-1d0/8*p1p2*p1p3*p4p5/s**3+1d0/4*p1p2*p1p
     & 4*p2p3/s**3+1d0/8*p1p2*p1p4*p3p5/s**3-1d0/8*p1p2*p2p3*p4p5/s**3+1
     & d0/8*p1p2*p2p4*p3p5/s**3-1d0/16*p1p3*p2p4/s**2+1d0/16*p1p4*p2p3/s
     & **2-1d0/16*p2p3*p4p5/s**2+1d0/16*p2p4*p3p5/s**2)
     & +a0spr*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(1d0/16*p
     & 1p3*p2p4/s**3+1d0/16*p1p3*p4p5/s**3-1d0/16*p1p4*p2p3/s**3-1d0/16*
     & p1p4*p3p5/s**3)
