...
************************************************************************
* File (nc-qcd_ha_14_23__14_16_16.f) is created on Wed Apr 18 13:41:34 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_14_23__14_16_16) to calculate
* differential cross-section of the gluon induced
* anti-dn + g -> anti-dn + mo^+ + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_14_23__14_16_16 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & +a0spr*iz1dn*betasprmomo/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(1d
