...
************************************************************************
* File (nc-qcd_ha_14_23__14_20_20.f) is created on Wed Apr 18 13:42:02 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_14_23__14_20_20) to calculate
* differential cross-section of the gluon induced
* anti-dn + g -> anti-dn + ta^+ + ta^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_14_23__14_20_20 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & +1d0/4*spr-1d0/4*s
      ...
      p1p3=
     & +costh3*(1d0/4*betasprtata*(s-spr))
     ...
     & +1d0/4*spr-1d0/4*s
      ...
      p2p3=
     & +sinph3*sinth3*sinth5*(-1d0/4*betasprtata*sq*sqspr)
     & +costh3*costh5*(-1d0/8*betasprtata*spr-1d0/8*betasprtata*s)
     & +costh3*(1d0/8*betasprtata*(s-spr))
     & +costh5*(1d0/8*(s-spr))
     & -1d0/8*spr-1d0/8*s
     ...
     & costh5/s**2)
      ...
      hard=
     & +v0spr*iz1dn**2*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*
     & (-1d0/8*p1p3*p2p4*mdn**2/s**2-1d0/8*p1p4*p2p3*mdn**2/s**2+1d0/8*p
     & 2p3*p4p5*mdn**2/s**2+1d0/8*p2p4*p3p5*mdn**2/s**2)
     & +v0spr*iz1dn*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(-1
     ...
     & **2)
     & +v0spr*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(1d0/16*p
     & 1p3*p2p4/s**3+1d0/16*p1p3*p4p5/s**3+1d0/16*p1p4*p2p3/s**3+1d0/16*
     & p1p4*p3p5/s**3+1d0/8*p2p3*p2p4/s**3)
     & +a0spr*iz1dn**2*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*
     & (1d0/8*p1p3*p2p4*mdn**2/s**2-1d0/8*p1p4*p2p3*mdn**2/s**2+1d0/8*p2
     & p3*p4p5*mdn**2/s**2-1d0/8*p2p4*p3p5*mdn**2/s**2)
     & +a0spr*iz1dn*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(1d
     ...
     & +a0spr*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(-1d0/16*
     & p1p3*p2p4/s**3-1d0/16*p1p3*p4p5/s**3+1d0/16*p1p4*p2p3/s**3+1d0/16
     & *p1p4*p3p5/s**3)
     & +vaspr*iz1dn**2*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*
     & (1d0/8*p1p2*mdn**2*mta**2/s**2-1d0/8*p2p5*mdn**2*mta**2/s**2)
     & +vaspr*iz1dn*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(1d
     & 0/8*p1p2*mta**2/s**2+1d0/4*p1p2**2*mta**2/s**3-1d0/16*p2p5*mta**2
     & /s**2)
     & +vaspr*betasprtata/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(-1d0/8*p
     & 1p2*mta**2/s**3-1d0/16*p1p5*mta**2/s**3)
