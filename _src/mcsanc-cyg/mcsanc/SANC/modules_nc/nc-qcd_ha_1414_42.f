...
************************************************************************
* File (nc-qcd_ha_1414_42.f) is created on Wed Apr 18 13:48:24 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_1414_42) to calculate differential
* hard gluon radiation for the anti-dn + dn -> H + Z process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_1414_42 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & vf**2+af**2)/pi**3*alphas*g**4/ctw**4*mdn**2/s**2/spr*(s-spr)*cf*
     & (-1d0/768*p1p3*p2p3+1d0/768*p2p3*p3p5)
     & +iz1dn**2*theta_hard(s,spr,omega)*propzspr*propzsprc*sqrtlsprzh*(
     & vf**2+af**2)/pi**3*alphas*g**4/ctw**4*mz**2*mdn**2/s**2/spr*(s-sp
     & r)*cf*(1d0/1536*p1p2)
     & +iz1dn**2*theta_hard(s,spr,omega)*propzspr*propzsprc*sqrtlsprzh*(
     & vf**2+af**2)/pi**3*alphas*g**4/ctw**4*mz**2*mdn**2/s**2/spr*(s-sp
     & r)**2*cf*(1d0/3072)
     ...
     & f*(1d0/768*p1p2**2)
     & +iz1dn*propzspr*propzsprc*sqrtlsprzh*(vf**2+af**2)/pi**3*alphas*g
     ...
     & vf**2+af**2)/pi**3*alphas*g**4/ctw**4*mz**2*mdn**2/s**2/spr*(s-sp
     & r)**2*cf*(1d0/3072)
     & +iz2dn*propzspr*propzsprc*sqrtlsprzh*(vf**2+af**2)/pi**3*alphas*g
     & **4/ctw**4/s**2/spr*(s-spr)*cf*(-1d0/1536*p1p3*p2p3+1d0/1536*p1p3
