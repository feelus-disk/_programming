...
************************************************************************
* File (nc-qcd_br_13_23__13_20_20.f) is created on Wed Apr 18 13:37:54 MSK 2012.
*****************************************************************************
* This is the FORTRAN module (nc_qcd_ha_13_23__13_20_20_1spr) to calculate
* differential cross-section for the gluon induced anti-up + g -> anti-up + ta^+ + ta^- process.
*
...
* E-mail: <sanc@jinr.ru>
*****************************************************************************
      subroutine nc_qcd_ha_13_23__13_20_20_1spr (s,spr,hard)
      implicit none!
     ...
     & +v0spr*betasprtata**3*log(1d0/mup**2*s)*((s-spr)**2+spr**2)*alpha
     & **2*alphas*cf*(1d0/48/s**3/spr)
     & +v0spr*betasprtata*log(1-1d0/s*spr)*((s-spr)**2+spr**2)*alpha**2*
     & alphas*cf*(1d0/8/s**3/spr)
     & +v0spr*betasprtata*log(1d0/mup**2*s)*((s-spr)**2+spr**2)*alpha**2
     ...
     & +vaspr*betasprtata*log(1d0/mup**2*s)*((s-spr)**2+spr**2)*alpha**2
