...
************************************************************************
* File (nc-qcd_ha_13_23__13_4_2.f) is created on Wed Apr 18 13:48:30 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_13_23__13_4_2) to calculate
* differential cross-section of the gluon induced
* anti-up + g -> anti-up + H + Z process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_13_23__13_4_2 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
      ...
      real*8 vf,af
      real*8 sqrtlsprzh,isqrtlsprzh,sqrtlsupspr,isqrtlsupspr
     ...
     & costh5/s**2)
      ...
      hard=
     & +iz1up**2*sqrtlsprzh*propzspr*propzsprc*(vf**2+af**2)/pi**3*alpha
     & s*g**4/ctw**4*mup**2/spr*(s-spr)*cf*(1d0/4096*p1p2*mz**2/s**2-1d0
     & /2048*p1p3*p2p3/s**2+1d0/2048*p2p3*p3p5/s**2-1d0/4096*p2p5*mz**2/
     & s**2)
     & +iz1up*sqrtlsprzh*propzspr*propzsprc*(vf**2+af**2)/pi**3*alphas*g
