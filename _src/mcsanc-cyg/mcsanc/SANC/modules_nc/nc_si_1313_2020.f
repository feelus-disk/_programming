...
************************************************************************
* File (nc_si_1313_2020.f) is created on Wed Apr 18 13:10:05 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_si_1313_2020) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_si_1313_2020 (s,t,u,sigma)
      implicit none!
     ...
     & +ffll*(-2*chizs*aup*ata+2*chizs*costhta*aup*ata-2*chizs*costhta*1
     & d0/sqrt(s)*sqrtpxstata*aup*ata+2*chizs*1d0/sqrt(s)*sqrtpxstata*au
     & p*ata)
     & +fflq*(-2*chizs*aup*vmata+2*chizs*costhta*aup*vmata)
     & +ffql*(-chizs*vmaup*ata+chizs*costhta*vmaup*ata-chizs*costhta*1d0
     & /sqrt(s)*sqrtpxstata*vmaup*ata+chizs*1d0/sqrt(s)*sqrtpxstata*vmau
     & p*ata)
