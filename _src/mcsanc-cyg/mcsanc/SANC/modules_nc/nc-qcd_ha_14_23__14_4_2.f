...
************************************************************************
* File (nc-qcd_ha_14_23__14_4_2.f) is created on Wed Apr 18 13:48:39 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_14_23__14_4_2) to calculate
* differential cross-section of the gluon induced
* anti-dn + g -> anti-dn + H + Z process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_14_23__14_4_2 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
