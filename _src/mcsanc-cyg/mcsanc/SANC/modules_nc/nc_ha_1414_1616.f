...
************************************************************************
* File (nc_ha_1414_1616.f) is created on Wed Apr 18 13:32:01 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_ha_1414_1616) to calculate differential
* hard photon Bremsstrahlung for the anti-dn + dn -> mo^+ + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_ha_1414_1616 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
      ...
      real*8 betasdndn,ibetasdndn,betasprmomo,ibetasprmomo
     ...
     & +(chizs*chizsprc+chizsc*chizspr)*a2z
      ...
      v2sspr =
     & +2d0*qdn**2*qmo**2
     & +qdn*qmo*(chizs+chizsc+chizspr+chizsprc)*v1z
     ...
     & +betasprmomo*costh4*(s-spr)*(1d0/4)
      ...
      hardisr=
     & +a0spr*iz1dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**3*q
     & dn**2*mdn**2*(s-spr)*(-1d0/3*p1p3*p2p4/s**2/spr**2+1d0/3*p1p4*p2p
     & 3/s**2/spr**2-1d0/3*p2p3*p4p5/s**2/spr**2+1d0/3*p2p4*p3p5/s**2/sp
     & r**2)
     & +a0spr*iz1dn*iz2dn*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**
     ...
     & +a0spr*iz1dn*betasprmomo/pi*alpha**3*qdn**2*(s-spr)*(-1d0/6*p1p3*
     & p2p4/s**2/spr**2+1d0/6*p1p4*p2p3/s**2/spr**2-1d0/6*p2p3*p4p5/s**2
     & /spr**2+1d0/6*p2p4*p3p5/s**2/spr**2)
     & +a0spr*iz2dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**3*q
     & dn**2*mdn**2*(s-spr)*(-1d0/3*p1p3*p2p4/s**2/spr**2+1d0/3*p1p3*p4p
     & 5/s**2/spr**2+1d0/3*p1p4*p2p3/s**2/spr**2-1d0/3*p1p4*p3p5/s**2/sp
     & r**2)
     & +a0spr*iz2dn*betasprmomo/pi*alpha**3*qdn**2*(s-spr)*(-1d0/6*p1p3*
     & p2p4/s**2/spr**2+1d0/6*p1p3*p4p5/s**2/spr**2+1d0/6*p1p4*p2p3/s**2
     & /spr**2-1d0/6*p1p4*p3p5/s**2/spr**2)
     & +v0spr*iz1dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**3*q
     & dn**2*mdn**2*(s-spr)*(-1d0/3*p1p3*p2p4/s**2/spr**2-1d0/3*p1p4*p2p
     & 3/s**2/spr**2+1d0/3*p2p3*p4p5/s**2/spr**2+1d0/3*p2p4*p3p5/s**2/sp
     & r**2)
     & +v0spr*iz1dn*iz2dn*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**
     & 3*qdn**2*(s-spr)*(1d0/3*p1p3*p2p4/s/spr**2-1d0/6*p1p3*p4p5/s/spr*
     & *2+1d0/3*p1p4*p2p3/s/spr**2-1d0/6*p1p4*p3p5/s/spr**2-1d0/6*p2p3*p
     & 4p5/s/spr**2-1d0/6*p2p4*p3p5/s/spr**2)
     & +v0spr*iz1dn*betasprmomo/pi*alpha**3*qdn**2*(s-spr)*(1d0/3*p1p3*p
     & 1p4/s**2/spr**2-1d0/6*p1p3*p2p4/s**2/spr**2-1d0/6*p1p4*p2p3/s**2/
     & spr**2+1d0/6*p2p3*p4p5/s**2/spr**2+1d0/6*p2p4*p3p5/s**2/spr**2)
     & +v0spr*iz2dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**3*q
     & dn**2*mdn**2*(s-spr)*(-1d0/3*p1p3*p2p4/s**2/spr**2+1d0/3*p1p3*p4p
     & 5/s**2/spr**2-1d0/3*p1p4*p2p3/s**2/spr**2+1d0/3*p1p4*p3p5/s**2/sp
     & r**2)
     & +v0spr*iz2dn*betasprmomo/pi*alpha**3*qdn**2*(s-spr)*(-1d0/6*p1p3*
     & p2p4/s**2/spr**2+1d0/6*p1p3*p4p5/s**2/spr**2-1d0/6*p1p4*p2p3/s**2
     & /spr**2+1d0/6*p1p4*p3p5/s**2/spr**2+1d0/3*p2p3*p2p4/s**2/spr**2)
     & +vaspr*iz1dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**3*q
     & dn**2*mdn**2*mmo**2*(s-spr)*(-1d0/6/s**2/spr)
     & +vaspr*iz1dn*iz2dn*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**
     & 3*qdn**2*mmo**2*(s-spr)*(1d0/6/spr**2)
     & +vaspr*iz1dn*betasprmomo/pi*alpha**3*qdn**2*mmo**2*(s-spr)*(-1d0/
     & 12/s**2/spr-1d0/12/s/spr**2)
     & +vaspr*iz2dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**3*q
     & dn**2*mdn**2*mmo**2*(s-spr)*(-1d0/6/s**2/spr)
     & +vaspr*iz2dn*betasprmomo/pi*alpha**3*qdn**2*mmo**2*(s-spr)*(-1d0/
     & 12/s**2/spr-1d0/12/s/spr**2)
     & +vaspr*betasprmomo/pi*alpha**3*qdn**2*mmo**2*(s-spr)*(-1d0/6/s**2
     & /spr**2)

      hardifi=
     & +a2sspr*iz1dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)*(-1d0/3*p1p3*p1p4*p2p3/s**3/spr+1d0/3*p1p3**2*
     & p2p4/s**3/spr)
     & +a2sspr*iz1dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)**2*(1d0/12*p1p3*p1p4/s**3/spr-1d0/12*p1p3*p2p3
     & /s**3/spr)
     & +a2sspr*iz1dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)*(-1d0/3*p1p3*p1p4*p2p4/s**3/spr+1d0/3*p1p4**2*
     & p2p3/s**3/spr)
     & +a2sspr*iz1dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)**2*(1d0/12*p1p3*p1p4/s**3/spr-1d0/12*p1p4*p2p4
     & /s**3/spr)
     & +a2sspr*iz1dn*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(1d0/12*p1p
     ...
     & 2/spr)
     & +a2sspr*iz2dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)*(-1d0/3*p1p3*p2p3*p2p4/s**3/spr+1d0/3*p1p4*p2p
     & 3**2/s**3/spr)
     & +a2sspr*iz2dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)**2*(-1d0/12*p1p3*p2p3/s**3/spr+1d0/12*p2p3*p2p
     & 4/s**3/spr)
     & +a2sspr*iz2dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)*(1d0/3*p1p3*p2p4**2/s**3/spr-1d0/3*p1p4*p2p3*p
     & 2p4/s**3/spr)
     & +a2sspr*iz2dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)**2*(-1d0/12*p1p4*p2p4/s**3/spr+1d0/12*p2p3*p2p
     & 4/s**3/spr)
     & +a2sspr*iz2dn*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(1d0/12*p1p
     ...
     & 2/spr)
     & +a2sspr*iz3mo*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(-1d0/12*p1
     ...
     & +a2sspr*iz3mo*betasprmomo/pi*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0
     & /12*p1p3/s**3/spr+1d0/12*p1p4/s**3/spr+1d0/12*p2p3/s**3/spr+1d0/1
     & 2*p2p4/s**3/spr)
     & +a2sspr*iz4mo*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(-1d0/12*p1
     ...
     & +a2sspr*iz4mo*betasprmomo/pi*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0
     & /12*p1p3/s**3/spr+1d0/12*p1p4/s**3/spr+1d0/12*p2p3/s**3/spr+1d0/1
     & 2*p2p4/s**3/spr)
     & +a2sspr*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(-1d0/12*p1p3/s**
     & 3/spr-1d0/12*p1p4/s**3/spr-1d0/12*p2p3/s**3/spr-1d0/12*p2p4/s**3/
     & spr)
     & +v2sspr*iz1dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)*(1d0/3*p1p3*p1p4*p2p3/s**3/spr+1d0/3*p1p3**2*p
     & 2p4/s**3/spr)
     & +v2sspr*iz1dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)**2*(-1d0/12*p1p3*p1p4/s**3/spr+1d0/12*p1p3*p2p
     & 3/s**3/spr)
     & +v2sspr*iz1dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)*(-1d0/3*p1p3*p1p4*p2p4/s**3/spr-1d0/3*p1p4**2*
     & p2p3/s**3/spr)
     & +v2sspr*iz1dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)**2*(1d0/12*p1p3*p1p4/s**3/spr-1d0/12*p1p4*p2p4
     & /s**3/spr)
     & +v2sspr*iz1dn*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(-1d0/12*p1
     ...
     & *2/spr)
     & +v2sspr*iz2dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)*(-1d0/3*p1p3*p2p3*p2p4/s**3/spr-1d0/3*p1p4*p2p
     & 3**2/s**3/spr)
     & +v2sspr*iz2dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)**2*(-1d0/12*p1p3*p2p3/s**3/spr+1d0/12*p2p3*p2p
     & 4/s**3/spr)
     & +v2sspr*iz2dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)*(1d0/3*p1p3*p2p4**2/s**3/spr+1d0/3*p1p4*p2p3*p
     & 2p4/s**3/spr)
     & +v2sspr*iz2dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo/pi*alpha*
     & *3*qdn*qmo*(s-spr)**2*(1d0/12*p1p4*p2p4/s**3/spr-1d0/12*p2p3*p2p4
     & /s**3/spr)
     & +v2sspr*iz2dn*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(1d0/12*p1p
     & 3*p2p3/s**3/spr+1d0/12*p1p3*p2p4/s**3/spr-1d0/12*p1p4*p2p3/s**3/s
     & pr-1d0/12*p1p4*p2p4/s**3/spr-1d0/24*p2p3/s**2/spr+1d0/24*p2p4/s**
     & 2/spr)
     & +v2sspr*iz3mo*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(1d0/12*p1p
     & 3*p1p4/s**3/spr-1d0/12*p1p3*p2p4/s**3/spr-1d0/24*p1p3/s**3+1d0/12
     & *p1p4*p2p3/s**3/spr-1d0/12*p2p3*p2p4/s**3/spr+1d0/24*p2p3/s**3)
     & +v2sspr*iz3mo*betasprmomo/pi*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0
     & /12*p1p3/s**3/spr-1d0/12*p1p4/s**3/spr-1d0/12*p2p3/s**3/spr+1d0/1
     & 2*p2p4/s**3/spr)
     & +v2sspr*iz4mo*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(-1d0/12*p1
     & p3*p1p4/s**3/spr-1d0/12*p1p3*p2p4/s**3/spr+1d0/12*p1p4*p2p3/s**3/
     & spr+1d0/24*p1p4/s**3+1d0/12*p2p3*p2p4/s**3/spr-1d0/24*p2p4/s**3)
     & +v2sspr*iz4mo*betasprmomo/pi*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0
     & /12*p1p3/s**3/spr-1d0/12*p1p4/s**3/spr-1d0/12*p2p3/s**3/spr+1d0/1
     & 2*p2p4/s**3/spr)
     & +v2sspr*betasprmomo/pi*alpha**3*qdn*qmo*(s-spr)*(-1d0/12*p1p3/s**
     & 3/spr+1d0/12*p1p4/s**3/spr+1d0/12*p2p3/s**3/spr-1d0/12*p2p4/s**3/
     & spr)
     & +vasspr*iz1dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo*(s+spr)/p
     & i*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0/12*p1p3/s**3/spr)
     & +vasspr*iz1dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo*(s+spr)/p
     & i*alpha**3*qdn*qmo*mmo**2*(s-spr)*(-1d0/12*p1p4/s**3/spr)
     & +vasspr*iz2dn*iz3mo*theta_hard(s,spr,omega)*betasprmomo*(s+spr)/p
     & i*alpha**3*qdn*qmo*mmo**2*(s-spr)*(-1d0/12*p2p3/s**3/spr)
     & +vasspr*iz2dn*iz4mo*theta_hard(s,spr,omega)*betasprmomo*(s+spr)/p
     & i*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0/12*p2p4/s**3/spr)
     & +vasspr*iz3mo*betasprmomo/pi*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0
     & /12*p1p5/s**3/spr-1d0/12*p2p5/s**3/spr)
     & +vasspr*iz4mo*betasprmomo/pi*alpha**3*qdn*qmo*mmo**2*(s-spr)*(-1d
     & 0/12*p1p5/s**3/spr+1d0/12*p2p5/s**3/spr)
     & +a1sspr*iz3mo*betasprmomo*(s+spr)/pi*alpha**3*qdn**2*qmo**2*mmo**
     & 2*(s-spr)*(1d0/24/s**3/spr)
     & +a1sspr*iz4mo*betasprmomo*(s+spr)/pi*alpha**3*qdn**2*qmo**2*mmo**
     & 2*(s-spr)*(1d0/24/s**3/spr)
