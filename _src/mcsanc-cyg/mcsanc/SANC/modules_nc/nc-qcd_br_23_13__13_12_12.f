...
************************************************************************
* File (nc-qcd_br_23_13__13_12_12.f) is created on Wed Apr 18 13:36:46 MSK 2012.
*****************************************************************************
* This is the FORTRAN module (nc_qcd_ha_23_13__13_12_12_1spr) to calculate
* differential cross-section for the gluon induced g + up -> up + el^+ + el^- process.
*
...
* E-mail: <sanc@jinr.ru>
*****************************************************************************
      subroutine nc_qcd_ha_23_13__13_12_12_1spr (s,spr,hard)
      implicit none!
