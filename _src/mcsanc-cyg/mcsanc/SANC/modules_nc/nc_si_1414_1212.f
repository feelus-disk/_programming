...
************************************************************************
* File (nc_si_1414_1212.f) is created on Wed Apr 18 13:10:17 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_si_1414_1212) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_si_1414_1212 (s,t,u,sigma)
      implicit none!
     ...
     & 0d0
      ...
      amp(1,2,1,2) =
     & +ffgg*(-qel*qdn+costhel*qel*qdn)
     & +ffqq*(-chizs*vmael*vmadn+chizs*costhel*vmael*vmadn)
     & +fflq*(-2*chizs*adn*vmael+2*chizs*costhel*adn*vmael)

      amp(1,2,2,1) =
     & +ffgg*(-qel*qdn-costhel*qel*qdn)
     & +ffqq*(-chizs*vmael*vmadn-chizs*costhel*vmael*vmadn)
     & +ffll*(-4*chizs*ael*adn-4*chizs*costhel*ael*adn)
     & +fflq*(-2*chizs*adn*vmael-2*chizs*costhel*adn*vmael)
     & +ffql*(-2*chizs*ael*vmadn-2*chizs*costhel*ael*vmadn)
