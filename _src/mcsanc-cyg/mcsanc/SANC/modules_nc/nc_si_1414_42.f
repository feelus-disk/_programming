...
************************************************************************
* File (nc_si_1414_42.f) is created on Wed Apr 18 13:48:01 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_si_1414_42) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_si_1414_42 (s,t,u,sigma)
      implicit none!
     ...
     & 0d0
      ...
      amp(1,2,1) =
     & +propzs*ffgp0*i_*g**2/sr2*(+1d0/2*costhz*sqrt(s)/ctw**2*vpadn*mz+
     & 1d0/2*sqrt(s)/ctw**2*vpadn*mz)
     ...
     & *2*mz+1d0/8*sqrt(s)*sqrtlszh/ctw**2*mz)
      ...
      amp(1,2,3) =
     & +propzs*ffgp0*i_*g**2*(-1d0/4*sinf/ctw**2*vpadn*s+1d0/4*sinf/ctw*
     & *2*vpadn*mh**2-1d0/4*sinf/ctw**2*vpadn*mz**2)
     ...
     & *2*mz-1d0/8*sqrt(s)*sqrtlszh/ctw**2*mz)
      ...
      amp(2,1,1) =
     & +propzs*ffgm0*i_*g**2/sr2*(-1d0/2*costhz*sqrt(s)/ctw**2*vmadn*mz+
     & 1d0/2*sqrt(s)/ctw**2*vmadn*mz)
     ...
     & *2*mz-1d0/8*sqrt(s)*sqrtlszh/ctw**2*mz)
      ...
      amp(2,1,3) =
     & +propzs*ffgm0*i_*g**2*(+1d0/4*sinf/ctw**2*vmadn*s-1d0/4*sinf/ctw*
     & *2*vmadn*mh**2+1d0/4*sinf/ctw**2*vmadn*mz**2)
