...
************************************************************************
* File (nc-qcd_br_1313_42.f) created on Wed Apr 18 13:48:21 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_br_1313_42) to calculate QCD soft
* gluon radiation cross section for the anti-up + up -> H + Z process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_br_1313_42 (qs,ts,us,born,soft,hard)
      implicit none!
     ...
     & z**6*mh**2/s**2+1d0/96*mz**8/s**2)
      ...
      softvirt=
     & +born/pi*alphas*cf*(-2)
     & +log(1d0/mup**2*s)*born/pi*alphas*cf*(3d0/2)
     & +log(4*omega**2/s)*born/pi*alphas*cf*(-1)
     & +log(4*omega**2/s)*log(1d0/mup**2*s)*born/pi*alphas*cf*(1)
