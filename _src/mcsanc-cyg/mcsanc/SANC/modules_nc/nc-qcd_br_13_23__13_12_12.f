...
************************************************************************
* File (nc-qcd_br_13_23__13_12_12.f) is created on Wed Apr 18 13:37:00 MSK 2012.
*****************************************************************************
* This is the FORTRAN module (nc_qcd_ha_13_23__13_12_12_1spr) to calculate
* differential cross-section for the gluon induced anti-up + g -> anti-up + el^+ + el^- process.
*
...
* E-mail: <sanc@jinr.ru>
*****************************************************************************
      subroutine nc_qcd_ha_13_23__13_12_12_1spr (s,spr,hard)
      implicit none!
     ...
     & d0/6/s**3/spr)
     & +v0spr*log(1d0/mup**2*s)*((s-spr)**2+spr**2)*alpha**2*alphas*cf*(
     & 1d0/12/s**3/spr)
