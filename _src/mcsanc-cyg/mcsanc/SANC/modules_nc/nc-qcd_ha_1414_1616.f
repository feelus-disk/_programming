...
************************************************************************
* File (nc-qcd_ha_1414_1616.f) is created on Wed Apr 18 13:36:29 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_qcd_ha_1414_1616) to calculate differential
* hard gluon radiation for the anti-dn + dn -> mo^+ + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_qcd_ha_1414_1616 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
      ...
      real*8 betasprmomo,ibetasprmomo,betasdndn,ibetasdndn
      real*8 iz1dn,iz2dn
     ...
     & *betasdndn*costh5)
      ...
      hard=
     & +v0spr*iz1dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**2*a
     ...
     & +v0spr*iz1dn*betasprmomo/pi*alpha**2*alphas*(s-spr)*cf*(1d0/3*p1p
     & 3*p1p4/s**2/spr**2-1d0/6*p1p3*p2p4/s**2/spr**2-1d0/6*p1p4*p2p3/s*
     & *2/spr**2+1d0/6*p2p3*p4p5/s**2/spr**2+1d0/6*p2p4*p3p5/s**2/spr**2
     & )
     & +v0spr*iz2dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**2*a
     ...
     & +v0spr*iz2dn*betasprmomo/pi*alpha**2*alphas*(s-spr)*cf*(-1d0/6*p1
     & p3*p2p4/s**2/spr**2+1d0/6*p1p3*p4p5/s**2/spr**2-1d0/6*p1p4*p2p3/s
     & **2/spr**2+1d0/6*p1p4*p3p5/s**2/spr**2+1d0/3*p2p3*p2p4/s**2/spr**
     & 2)
     & +a0spr*iz1dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**2*a
     & lphas*(s-spr)*cf*(-1d0/3*p1p3*p2p4*mdn**2/s**2/spr**2+1d0/3*p1p4*
     & p2p3*mdn**2/s**2/spr**2-1d0/3*p2p3*p4p5*mdn**2/s**2/spr**2+1d0/3*
     & p2p4*p3p5*mdn**2/s**2/spr**2)
     ...
     & pr**2-1d0/3*p1p4*p2p3/s/spr**2+1d0/6*p1p4*p3p5/s/spr**2+1d0/6*p2p
     & 3*p4p5/s/spr**2-1d0/6*p2p4*p3p5/s/spr**2)
     & +a0spr*iz1dn*betasprmomo/pi*alpha**2*alphas*(s-spr)*cf*(-1d0/6*p1
     & p3*p2p4/s**2/spr**2+1d0/6*p1p4*p2p3/s**2/spr**2-1d0/6*p2p3*p4p5/s
     & **2/spr**2+1d0/6*p2p4*p3p5/s**2/spr**2)
     & +a0spr*iz2dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**2*a
     & lphas*(s-spr)*cf*(-1d0/3*p1p3*p2p4*mdn**2/s**2/spr**2+1d0/3*p1p3*
     & p4p5*mdn**2/s**2/spr**2+1d0/3*p1p4*p2p3*mdn**2/s**2/spr**2-1d0/3*
     & p1p4*p3p5*mdn**2/s**2/spr**2)
     & +a0spr*iz2dn*betasprmomo/pi*alpha**2*alphas*(s-spr)*cf*(-1d0/6*p1
     & p3*p2p4/s**2/spr**2+1d0/6*p1p3*p4p5/s**2/spr**2+1d0/6*p1p4*p2p3/s
     & **2/spr**2-1d0/6*p1p4*p3p5/s**2/spr**2)
     & +vaspr*iz1dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**2*a
     & lphas*(s-spr)*cf*(-1d0/6*mdn**2*mmo**2/s**2/spr)
     & +vaspr*iz1dn*iz2dn*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**
     & 2*alphas*(s-spr)*cf*(1d0/6*mmo**2/spr**2)
     & +vaspr*iz1dn*betasprmomo/pi*alpha**2*alphas*(s-spr)*cf*(-1d0/12*m
     & mo**2/s**2/spr-1d0/12*mmo**2/s/spr**2)
     & +vaspr*iz2dn**2*theta_hard(s,spr,omega)*betasprmomo/pi*alpha**2*a
     & lphas*(s-spr)*cf*(-1d0/6*mdn**2*mmo**2/s**2/spr)
     & +vaspr*iz2dn*betasprmomo/pi*alpha**2*alphas*(s-spr)*cf*(-1d0/12*m
     & mo**2/s**2/spr-1d0/12*mmo**2/s/spr**2)
