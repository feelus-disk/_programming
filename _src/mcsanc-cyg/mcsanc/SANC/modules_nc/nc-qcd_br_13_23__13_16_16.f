...
************************************************************************
* File (nc-qcd_br_13_23__13_16_16.f) is created on Wed Apr 18 13:37:27 MSK 2012.
*****************************************************************************
* This is the FORTRAN module (nc_qcd_ha_13_23__13_16_16_1spr) to calculate
* differential cross-section for the gluon induced anti-up + g -> anti-up + mo^+ + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
*****************************************************************************
      subroutine nc_qcd_ha_13_23__13_16_16_1spr (s,spr,hard)
      implicit none!
