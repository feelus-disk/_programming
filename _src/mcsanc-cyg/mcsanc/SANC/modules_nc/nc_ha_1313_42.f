...
************************************************************************
* File (nc_ha_1313_42.f) is created on Wed Apr 18 13:48:18 MSK 2012.
************************************************************************
* This is the FORTRAN module (nc_ha_1313_42) to calculate differential
* hard photon Bremsstrahlung for the anti-up + up -> H + Z process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine nc_ha_1313_42 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & vf**2+af**2)/pi**3*alpha*g**4/ctw**6*qup**2*mw**2*mup**2/s**2/spr
     ...
     & h*(vf**2+af**2)/pi**3*alpha*g**4/ctw**6*qup**2*mw**2/s**2/spr*(s-
     & spr)*(-1d0/384*p1p2*p1p3*p2p3/mz**2+1d0/768*p1p2*p1p3*p3p5/mz**2+
     & 1d0/768*p1p2*p2p3*p3p5/mz**2+1d0/768*p1p2**2)
     & +iz1up*propzspr*propzsprc*sqrtlsprzh*(vf**2+af**2)/pi**3*alpha*g*
     & *4/ctw**6*qup**2*mw**2/s**2/spr*(s-spr)*(1d0/1536*p1p2-1d0/1536*p
     & 1p3*p2p3/mz**2+1d0/1536*p1p3**2/mz**2+1d0/1536*p2p3*p3p5/mz**2)
     & +iz1up*propzspr*propzsprc*sqrtlsprzh*(vf**2+af**2)/pi**3*alpha*g*
     & *4/ctw**6*qup**2*mw**2/s**2/spr*(s-spr)**2*(1d0/6144)
