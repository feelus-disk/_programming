...
c      PARAMETER (F1=1.64493406684822618D0)
c*
c      IF(X)8,1,1
c1     IF(X-.5D0)2,2,3
c2     SPENCE=FSPENS(X)
c      RETURN
c3     IF(X-1.D0)4,4,5
c4     SPENCE=F1-LOG(X)*LOG(1D0-X+1D-15)-FSPENS(1D0-X)
c      RETURN
c5     IF(X-2.D0)6,6,7
c6     SPENCE=F1-.5D0*LOG(X)*LOG((X-1D0)**2/X)+FSPENS(1D0-1D0/X)
c      RETURN
c7     SPENCE=2D0*F1-.5D0*LOG(X)**2-FSPENS(1D0/X)
c      RETURN
c8     IF(X+1.D0)10,9,9
c9     SPENCE=-.5D0*LOG(1D0-X)**2-FSPENS(X/(X-1D0))
c      RETURN
c10    SPENCE=-.5D0*LOG(1D0-X)*LOG(X**2/(1D0-X))-F1+FSPENS(1D0/(1D0-X))
c      END
