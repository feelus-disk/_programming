...
************************************************************************
* File (cc-qcd_br_1413_2019.f) is created on Tue Aug  9 22:38:12 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_br_1413_2019) to calculate EW Born
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_br_1413_2019 (qs,ts,us,born,soft,hard)
      implicit none!
...
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_1413_2019_1spr) to calculate hard
* gluon radiation for the anti-dn + up -> ta^+ + tn process.
*
* It is produced by s2n package of SANC (v1.10) Project.
* Copyright (C), SANC Project Team, 2002-2011.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_1413_2019_1spr (s,spr,hard)
      implicit none!
      include 's2n_declare.h'
