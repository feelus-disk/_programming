...
************************************************************************
* File (cc-qcd_ha_14_23__22_13_21.f) is created on Mon Mar 26 11:57:04 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_14_23__22_13_21) to calculate
* differential cross-section of the gluon induced
* anti-dn + g -> anti-bt + anti-up + tp process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_14_23__22_13_21 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
