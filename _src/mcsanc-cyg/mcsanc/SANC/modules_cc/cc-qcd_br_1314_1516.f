...
************************************************************************
* File (cc-qcd_br_1314_1516.f) is created on Tue Aug  9 22:38:07 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_br_1314_1516) to calculate EW Born
* cross section and QCD virtual corrections 
* for the anti-up + dn -> mn + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_br_1314_1516 (qs,ts,us,born,soft,hard)
      implicit none!
      ...
      born=
     & +chiws*chiwsc*pi*alpha**2*(1d0/24/s-1d0/24*mmo**2/s**2-1d0/24*mmo
     & **4/s**3+1d0/24*mmo**6/s**4)
     & +chiws*chiwsc*cosf*pi*alpha**2*(-1d0/12/s+1d0/6*mmo**2/s**2-1d0/1
     & 2*mmo**4/s**3)
     & +chiws*chiwsc*cosf**2*pi*alpha**2*(1d0/24/s-1d0/8*mmo**2/s**2+1d0
     & /8*mmo**4/s**3-1d0/24*mmo**6/s**4)
...
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_1314_1516_1spr) to calculate hard
* gluon radiation for the anti-up + dn -> mn + mo^- process.
*
* It is produced by s2n package of SANC (v1.10) Project.
* Copyright (C), SANC Project Team, 2002-2011.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_1314_1516_1spr (s,spr,hard)
      implicit none!
      include 's2n_declare.h'
     ...
     & -1d0/12*mmo**2/s**2/spr-1d0/6*mmo**2/s**2/(s-spr)*theta_hard(s,sp
     & r,omega)-1d0/12*mmo**2/s/spr**2+1d0/18*mmo**6/s**4/spr+1d0/18*mmo
     & **6/s**4/(s-spr)*theta_hard(s,spr,omega)
     & +1d0/18*mmo**6/s**3/spr**2+1d0/36*mmo**6/s**2/spr**3+1d0/36*mmo**
     & 6/s/spr**4)
