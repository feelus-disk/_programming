...
************************************************************************
* File (cc-qcd_ha_13_23__14_3_4.f) is created on Mon Mar 26 11:57:15 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_13_23__14_3_4) to calculate
* differential cross-section of the gluon induced
* anti-up + g -> anti-dn + W^- + H process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_13_23__14_3_4 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
