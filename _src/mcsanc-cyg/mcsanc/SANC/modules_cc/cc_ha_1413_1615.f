...
************************************************************************
* File (cc_ha_1413_1615.f) is created on Tue Aug  9 22:37:56 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_ha_1413_1615) to calculate differential
* hard photon Bremsstrahlung for the anti-dn + up -> mo^+ + mn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_1413_1615 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
      ...
      real*8 iz1dn,iz2up,iz3mn,iz4mo
     ...
     & -1d0/2*mdn**2/s+1d0/2*mup**2/s+1d0/2*costh5*sqrtlsupdn/s)
      ...
      iz4mo=
     & +1d0/(mmo**2/spr+1d0/4*sinth4**2-1d0/2*sinth4**2*mmo**2/spr+1d0/4
     & *sinth4**2*mmo**4/spr**2)/(s-spr)*(1d0/2+1d0/2*mmo**2/spr+1d0/2*c
     & osth4-1d0/2*costh4*mmo**2/spr)
     ...
     & /s**2/spr**2)
     & +iz1dn**2*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3*qd
     & n**2*mdn**2*mmo**2*(s-spr)*(1d0/6*p1p3*p2p4/s**2/spr**3-1d0/6*p2p
     & 4*p3p5/s**2/spr**3)
     ...
     & +iz1dn*iz2up*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3
     & *qdn*mmo**2*(s-spr)*(-1d0/6*p1p3*p2p4/s/spr**3+1d0/12*p1p3*p4p5/s
     & /spr**3+1d0/12*p2p4*p3p5/s/spr**3)
     & +iz1dn*iz2up*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3
     & *qdn**2*(s-spr)*(1d0/6*p1p3*p2p4/s/spr**2-1d0/12*p1p3*p4p5/s/spr*
     & *2-1d0/12*p2p4*p3p5/s/spr**2)
     & +iz1dn*iz2up*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3
     & *qdn**2*mmo**2*(s-spr)*(-1d0/6*p1p3*p2p4/s/spr**3+1d0/12*p1p3*p4p
     ...
     & +iz1dn*chiwspr*chiwsprc/pi*alpha**3*qdn*mmo**2*(1d0/6*p1p3*p2p4/s
     ...
     & 2/spr**2)
     & +iz1dn*chiwspr*chiwsprc/pi*alpha**3*qdn**2*mmo**2*(s-spr)*(-1d0/1
     ...
     & /s**2/spr**2)
     & +iz2up**2*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3*qu
     & p**2*mup**2*mmo**2*(s-spr)*(1d0/6*p1p3*p2p4/s**2/spr**3-1d0/6*p1p
     & 3*p4p5/s**2/spr**3)
     & +iz2up*chiwspr*chiwsprc/pi*alpha**3*qup*(1d0/6*p1p3*p2p4/s/spr**2
     & -1d0/12*p1p3*p4p5/s/spr**2-1d0/12*p2p4*p3p5/s/spr**2)
     & +iz2up*chiwspr*chiwsprc/pi*alpha**3*qup*mmo**2*(-1d0/6*p1p3*p2p4/
     ...
     & *2/spr**2)
     & +iz2up*chiwspr*chiwsprc/pi*alpha**3*qup**2*mmo**2*(s-spr)*(1d0/12
     ...
     & 2p4/s**2/spr)
     & +chiwspr*chiwsprc/pi*alpha**3*qdn*mmo**2*(-1d0/12*p1p3*p1p4/s**2/
     & spr**3+1d0/12*p1p3*p2p4/s**2/spr**3-1d0/12*p2p4*p3p5/s**2/spr**3-
     & 1d0/12*p2p4/s**2/spr**2)
     & +chiwspr*chiwsprc/pi*alpha**3*qdn*mmo**4*(1d0/24*p2p4/s**2/spr**3
     & )
     ...
     & /s**2/spr**2)
     & +chiwspr*chiwsprc/pi*alpha**3*qup*mmo**2*(-1d0/12*p1p3*p2p4/s**2/
     & spr**3+1d0/12*p1p3*p4p5/s**2/spr**3+1d0/12*p2p3*p2p4/s**2/spr**3)
     & 
     & +chiwspr*chiwsprc/pi*alpha**3*qup*mmo**4*(1d0/24*p1p3/s**2/spr**3
     & )

      hardfsr=
     & +iz4mo**2*theta_hard(s,spr,omega)*chiws*chiwsc/pi*alpha**3*qmo*mm
     & o**2*(s-spr)*(1d0/6*p1p3*p2p4/s**4+1d0/6*p1p3*p2p5/s**4)
     & +iz4mo**2*theta_hard(s,spr,omega)*chiws*chiwsc/pi*alpha**3*qmo*mm
     & o**4*(s-spr)*(-1d0/6*p1p3*p2p4/s**4/spr-1d0/6*p1p3*p2p5/s**4/spr)
     & 
     & +iz4mo*chiws*chiwsc/pi*alpha**3*qmo*(-1d0/6*p1p3*p2p4/s**4*spr-1d
     & 0/12*p1p3*p2p5/s**4*spr-1d0/12*p1p5*p2p4/s**4*spr)
     & +iz4mo*chiws*chiwsc/pi*alpha**3*qmo*(s-spr)*(-1d0/12*p1p3*p2p4/s*
     & *4-1d0/12*p1p3*p2p5/s**4+1d0/12*p1p4*p2p4/s**4)
     & +iz4mo*chiws*chiwsc/pi*alpha**3*qmo*mmo**2*(-1d0/6*p1p3*p2p5/s**4
     & +1d0/6*p1p5*p2p4/s**4)
     & +iz4mo*chiws*chiwsc/pi*alpha**3*qmo*mmo**2*(s-spr)*(1d0/12*p1p3*p
     & 2p4/s**4/spr+1d0/12*p1p3*p2p5/s**4/spr-1d0/12*p1p4*p2p4/s**4/spr)
     & 
     & +iz4mo*chiws*chiwsc/pi*alpha**3*qmo*mmo**4*(1d0/6*p1p3*p2p4/s**4/
     ...
     & /s**3/spr)
     & +chiws*chiwsc/pi*alpha**3*mmo**4/(s-spr)*(1d0/12*p1p3*p2p5/s**4/s
     & pr-1d0/12*p1p5*p2p4/s**4/spr)
     & +chiws*chiwsc/pi*alpha**3*qmo*(-1d0/12*p1p3*p2p4/s**4+1d0/12*p1p3
     & *p2p5/s**4-1d0/24*p1p3/s**3-1d0/12*p1p4*p2p4/s**4)
     & +chiws*chiwsc/pi*alpha**3*qmo*mmo**2*(1d0/12*p1p3*p2p4/s**4/spr-1
     ...
     & +chichicwswspr/pi*alpha**3*qmo*(1d0/24*p1p3*p2p4/s**3/spr-1d0/24*
     & p1p3*p2p5/s**3/spr+1d0/48*p1p3/s**2/spr+1d0/24*p1p4*p2p4/s**3/spr
     & )
     & +chichicwswspr/pi*alpha**3*qmo*mmo**2*(-1d0/24*p1p3*p2p4/s**3/spr
     ...
     & +chichicwswspr/pi*alpha**3*qdn*mmo**2*(1d0/24*p1p3*p1p4/s**3/spr*
     & *2-1d0/24*p1p3*p2p4/s**3/spr**2+1d0/24*p2p4*p3p5/s**3/spr**2+1d0/
     & 24*p2p4/s**3/spr)
     & +chichicwswspr/pi*alpha**3*qdn*mmo**4*(-1d0/48*p2p4/s**3/spr**2)
     & +chichicwswspr/pi*alpha**3*qup*(-1d0/24*p1p3*p2p4/s**3/spr+1d0/24
     & *p1p3*p4p5/s**3/spr+1d0/48*p1p3/s**3+1d0/24*p2p3*p2p4/s**3/spr)
     & +chichicwswspr/pi*alpha**3*qup*mmo**2*(1d0/24*p1p3*p2p4/s**3/spr*
     & *2-1d0/24*p1p3*p4p5/s**3/spr**2-1d0/24*p2p3*p2p4/s**3/spr**2)
     & +chichicwswspr/pi*alpha**3*qup*mmo**4*(-1d0/48*p1p3/s**3/spr**2)
     & +chichicwswspr/pi*alpha**3*qup*qmo*(s-spr)*(-1d0/24*p1p3/s**3/spr
     & )
     & +chichicwswspr/pi*alpha**3*qup*qmo*mmo**2*(s-spr)*(1d0/24*p1p3/s*
     & *3/spr**2)
     ...
     & +chichicwswspr*iz1dn/pi*alpha**3*qdn*mmo**2*(-1d0/12*p1p3*p2p4/s*
     & *2/spr**2+1d0/24*p1p3*p4p5/s**2/spr**2+1d0/24*p2p4*p3p5/s**2/spr*
     & *2)
     & +chichicwswspr*iz1dn/pi*alpha**3*qdn*mmo**2*(s-spr)*(-1d0/24*p1p3
     & *p1p4/s**3/spr**2+1d0/24*p1p3*p2p4/s**3/spr**2)
     & +chichicwswspr*iz1dn/pi*alpha**3*qdn*qmo*(s-spr)*(-1d0/24*p1p3*p2
     & p4/s**3/spr+1d0/48*p1p3/s**2/spr+1d0/24*p1p4*p2p4/s**3/spr)
     & +chichicwswspr*iz1dn/pi*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0/24*p
     & 1p3*p2p4/s**3/spr**2-1d0/48*p1p3/s**2/spr**2-1d0/24*p1p4*p2p4/s**
     & 3/spr**2)
     & +chichicwswspr*iz1dn*iz4mo*theta_hard(s,spr,omega)/pi*alpha**3*qd
     & n*qmo*(s-spr)*(-1d0/6*p1p3*p1p4*p2p4/s**3/spr)
     & +chichicwswspr*iz1dn*iz4mo*theta_hard(s,spr,omega)/pi*alpha**3*qd
     & n*qmo*(s-spr)**2*(1d0/24*p1p3*p1p4/s**3/spr-1d0/24*p1p4*p2p4/s**3
     & /spr)
     & +chichicwswspr*iz1dn*iz4mo*theta_hard(s,spr,omega)/pi*alpha**3*qd
     & n*qmo*mmo**2*(s-spr)*(1d0/6*p1p3*p1p4*p2p4/s**3/spr**2)
     & +chichicwswspr*iz1dn*iz4mo*theta_hard(s,spr,omega)/pi*alpha**3*qd
     & n*qmo*mmo**2*(s-spr)**2*(-1d0/24*p1p3*p1p4/s**3/spr**2+1d0/24*p1p
     & 4*p2p4/s**3/spr**2)
     ...
     & +chichicwswspr*iz2up/pi*alpha**3*qup*mmo**2*(1d0/12*p1p3*p2p4/s**
     & 2/spr**2-1d0/24*p1p3*p4p5/s**2/spr**2-1d0/24*p2p4*p3p5/s**2/spr**
     & 2)
     & +chichicwswspr*iz2up/pi*alpha**3*qup*mmo**2*(s-spr)*(-1d0/24*p1p3
     & *p2p4/s**3/spr**2+1d0/24*p2p3*p2p4/s**3/spr**2)
     & +chichicwswspr*iz2up/pi*alpha**3*qup*qmo*(s-spr)*(1d0/12*p1p3*p2p
     & 4/s**3/spr)
     & +chichicwswspr*iz2up/pi*alpha**3*qup*qmo*mmo**2*(s-spr)*(-1d0/12*
     & p1p3*p2p4/s**3/spr**2)
     & +chichicwswspr*iz2up*iz4mo*theta_hard(s,spr,omega)/pi*alpha**3*qu
     & p*qmo*(s-spr)*(1d0/6*p1p3*p2p4**2/s**3/spr)
     & +chichicwswspr*iz2up*iz4mo*theta_hard(s,spr,omega)/pi*alpha**3*qu
     & p*qmo*mmo**2*(s-spr)*(-1d0/6*p1p3*p2p4**2/s**3/spr**2)
     & +chichicwswspr*iz4mo/pi*alpha**3*qmo*(1d0/12*p1p3*p2p4/s**3+1d0/2
     & 4*p1p3*p2p5/s**3+1d0/24*p1p5*p2p4/s**3)
     & +chichicwswspr*iz4mo/pi*alpha**3*qmo*(s-spr)*(1d0/24*p1p3*p2p4/s*
     & *3/spr-1d0/24*p1p4*p2p4/s**3/spr)
     & +chichicwswspr*iz4mo/pi*alpha**3*qmo*mmo**2*(1d0/12*p1p3*p2p5/s**
     & 3/spr-1d0/12*p1p5*p2p4/s**3/spr)
     & +chichicwswspr*iz4mo/pi*alpha**3*qmo*mmo**2*(s-spr)*(-1d0/24*p1p3
     & *p2p4/s**3/spr**2+1d0/24*p1p4*p2p4/s**3/spr**2)
     & +chichicwswspr*iz4mo/pi*alpha**3*qmo*mmo**4*(-1d0/12*p1p3*p2p4/s*
     & *3/spr**2-1d0/8*p1p3*p2p5/s**3/spr**2+1d0/24*p1p5*p2p4/s**3/spr**
     & 2)
     & +chichicwswspr*iz4mo/pi*alpha**3*qdn*qmo*(s-spr)*(-1d0/24*p1p3*p1
     & p4/s**3/spr+1d0/24*p1p3*p2p4/s**3/spr-1d0/48*p2p4/s**3)
     & +chichicwswspr*iz4mo/pi*alpha**3*qdn*qmo*mmo**2*(s-spr)*(1d0/24*p
     & 1p3*p1p4/s**3/spr**2-1d0/24*p1p3*p2p4/s**3/spr**2+1d0/24*p2p4/s**
     & 3/spr)
     & +chichicwswspr*iz4mo/pi*alpha**3*qdn*qmo*mmo**4*(s-spr)*(-1d0/48*
     & p2p4/s**3/spr**2)
     & +chichicwswspr*iz4mo/pi*alpha**3*qup*qmo*(s-spr)*(-1d0/12*p1p3*p2
     & p4/s**3/spr)
     & +chichicwswspr*iz4mo/pi*alpha**3*qup*qmo*mmo**2*(s-spr)*(1d0/12*p
     & 1p3*p2p4/s**3/spr**2+1d0/24*p1p3/s**3/spr)
     & +chichicwswspr*iz4mo/pi*alpha**3*qup*qmo*mmo**4*(s-spr)*(-1d0/24*
     & p1p3/s**3/spr**2)
