...
************************************************************************
* File (cc-qcd_ha_1413_2019.f) is created on Tue Aug  9 22:38:20 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_1413_2019) to calculate differential
* hard gluon radiation for the anti-dn + up -> ta^+ + tn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_1413_2019 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
     ...
     & 2p4*mdn**2*mta**2/s**2/spr**3+1d0/6*p2p4*p3p5*mdn**2/s**2/spr**2-
     & 1d0/6*p2p4*p3p5*mdn**2*mta**2/s**2/spr**3)
     ...
     & 2p4*mup**2*mta**2/s**2/spr**3+1d0/6*p1p3*p4p5*mup**2/s**2/spr**2-
     & 1d0/6*p1p3*p4p5*mup**2*mta**2/s**2/spr**3)
