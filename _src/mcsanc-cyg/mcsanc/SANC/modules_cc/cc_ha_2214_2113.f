...
************************************************************************
* File (cc_ha_2214_2113.f) is created on Tue Aug  9 23:00:15 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_ha_2214_2113) to calculate differential
* hard photon Bremsstrahlung for the anti-bt + dn -> anti-tp + up process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_2214_2113 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
