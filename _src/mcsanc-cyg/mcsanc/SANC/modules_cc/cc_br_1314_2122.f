...
************************************************************************
* File (cc_br_1314_2122.f) is created on Tue Aug  9 22:47:56 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_bo_1314_2122) to calculate EW
* integrated Born cross section for the anti-up + dn -> anti-tp + bt process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_bo_1314_2122 (s,born)
      implicit none!
      ...
      born=
     & +sqrtlstpbt*chiws*chiwsc*pi*alpha**2*(1d0/3/s**2-1d0/6*mbt**2/s**
...
************************************************************************
* This is the FORTRAN module (cc_br_1314_2122) to calculate EW Born
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_br_1314_2122 (qs,ts,us,born,soft,hard)
      implicit none!
      include 's2n_declare.h'

      real*8 qw
      real*8 softvirtisr,softvirtfsr,softvirtifi
      real*8 ln1sup,ln1sdn,jbwbttpsq,jbwtpbtsq
      real*8 sqrtlstpbt,sqrtlsbttp
      ...
      born=
     & +sqrtlstpbt*chiws*chiwsc*pi*alpha**2*(1d0/8/s**2-1d0/8*mbt**4/s**
     & 4+1d0/4*mtp**2*mbt**2/s**4-1d0/8*mtp**4/s**4)
     & +sqrtlstpbt*chiws*chiwsc*cosf**2*pi*alpha**2*(1d0/8/s**2-1d0/4*mb
     ...
     & +ibetasjtpbt*log(1d0/2+1d0/2*ibetasbttp)*log(sqrtlsbttp/s)*born/p
     & i*alpha*qtp*qbt*(-1)
     & +ibetasjtpbt*log(1d0/2+1d0/2*ibetastpbt)*log(sqrtlsbttp/s)*born/p
     & i*alpha*qtp*qbt*(-1)
     ...
     & +ibetasjtpbt*log(1d0/mtp**2*s)*log(sqrtlsbttp/s)*born/pi*alpha*qt
     & p*qbt*(-1)
     ...
     & 1d0/2)
     & +ibetasjtpbt*log(sqrtlsbttp/s)**2*born/pi*alpha*qtp*qbt*(-2)
     ...
     & +ibetasjtpbt*log(1d0/mbt**2*s)*log(sqrtlsbttp/s)*born/pi*alpha*qt
     & p*qbt*(-1)
