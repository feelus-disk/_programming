...
************************************************************************
* File (cc-qcd_br_23_13__14_12_11.f) is created on Tue Aug  9 23:04:43 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_23_13__14_12_11_1spr) to calculate
* the gluon induced g + up -> dn + el^+ + en process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_23_13__14_12_11_1spr (s,spr,hard)
      implicit none!
