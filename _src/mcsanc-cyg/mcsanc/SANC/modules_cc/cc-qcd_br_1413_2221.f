...
************************************************************************
* File (cc-qcd_br_1413_2221.f) is created on Tue Aug  9 22:48:54 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_br_1413_2221) to calculate EW Born
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_br_1413_2221 (qs,ts,us,born,soft,hard)
      implicit none!
...
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_1413_2221_1spr) to calculate hard
* gluon radiation for the anti-dn + up -> anti-bt + tp process.
*
* It is produced by s2n package of SANC (v1.10) Project.
* Copyright (C), SANC Project Team, 2002-2011.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_1413_2221_1spr (s,spr,hard)
      implicit none!
      include 's2n_declare.h'
     ...
     &    log((mtp**2-mbt**2-spr+sqrtlsprtpbt)/(mtp**2-mbt**2-spr-sqrtlsprtpbt))
      ...
      call cc_bo_1413_2221 (s,bornints)
      bornints = bornints/conhc

      call cc_bo_1413_2221 (spr,bornintspr)
