...
************************************************************************
* File (cc-qcd_br_13_23__14_21_22.f) is created on Mon Mar 26 11:56:55 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_13_23__14_21_22_1spr) to calculate
* the gluon induced anti-up + g  -> anti-dn + anti-tp + bt process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_13_23__14_21_22_1spr (s,spr,hard)
      implicit none!
     ...
     & +sqrtlsprtpbt*chiwspr*chiwsprc*log(1d0/mup**2*s)*((s-spr)**2+spr*
