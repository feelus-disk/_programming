...
************************************************************************
* File (cc-qcd_ha_14_23__13_22_21.f) is created on Mon Mar 26 11:56:58 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_14_23__13_22_21) to calculate
* differential cross-section of the gluon induced
* anti-dn + g  -> anti-up + anti-bt + tp process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_14_23__13_22_21 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
