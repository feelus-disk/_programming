...
************************************************************************
* File (cc-qcd_ha_23_13__22_14_21.f) is created on Mon Mar 26 11:57:03 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_23_13__22_14_21) to calculate
* differential cross-section of the gluon induced
* g + up -> anti-bt + dn + tp process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_23_13__22_14_21 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
