...
************************************************************************
* File (cc_si_1413_1211.f) is created on Tue Aug  9 22:36:34 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_si_1413_1211) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_si_1413_1211 (s,t,u,sigma)
      implicit none!
     ...
     & 0d0
      ...
      amp(1,2,2,1) =
     & +chiws*costhen*ffll*(-1)
     & +chiws*ffll*(-1)

      amp(1,2,2,2) =
     & +chiws*sinthen*ffrd*(-sqrt(s))
