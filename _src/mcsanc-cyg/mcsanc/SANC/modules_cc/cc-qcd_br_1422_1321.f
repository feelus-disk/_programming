...
************************************************************************
* File (cc-qcd_br_1422_1321.f) is created on Tue Aug  9 23:00:58 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_br_1422_1321) to calculate EW Born
* cross section and QCD virtual corrections 
* for the anti-dn + bt -> anti-up + tp process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_br_1422_1321 (qs,ts,us,born,soft,hard)
      implicit none!
      ...
      born=
     & +propwt*propwtc*(s-mtp**2)/pi*gf**2*mw**4*(1d0/4/(s-mbt**2)/s*(u-
     & mbt**2)*(u-mtp**2))
     ...
     & *2*mw**4/s*cf*(-1d0/16*jbwttpbt*mtp**2)
     & +sqrtltpbtt*propwt*propwtc*(s-mtp**2)/pi**2*alphas*gf**2*mw**4/s*
     & cf*(1d0/16*jbwttpbt)
     ...
     & )/pi**2*alphas*gf**2*mw**4*cf*(7d0/16*t**3-7d0/8*mtp**2*t**2+7d0/
     & 16*mtp**4*t)
     & +isqrtltpbtt**2*propwt*propwtc*log(mbt**2/s)*(s-mtp**2)/(s-mbt**2
     & )/pi**2*alphas*gf**2*mw**4*mbt**2*cf*(-7d0/8*t**2-7d0/8*mtp**2*t)
     & 
     & +isqrtltpbtt**2*propwt*propwtc*log(mbt**2/s)*(s-mtp**2)/(s-mbt**2
     & )/pi**2*alphas*gf**2*mw**4*mbt**4*cf*(7d0/16*t)
     & +isqrtltpbtt**2*propwt*propwtc*log(mbt**2/s)*(s-mtp**2)/pi**2*alp
     & has*gf**2*mw**4/s*cf*(-1d0/2*t**3+mtp**2*t**2-1d0/2*mtp**4*t)
     & +isqrtltpbtt**2*propwt*propwtc*log(mbt**2/s)*(s-mtp**2)/pi**2*alp
     & has*gf**2*mw**4*mbt**2/s*cf*(t**2+mtp**2*t)
     & +isqrtltpbtt**2*propwt*propwtc*log(mbt**2/s)*(s-mtp**2)/pi**2*alp
     & has*gf**2*mw**4*mbt**4/s*cf*(-1d0/2*t)
     ...
     & gf**2*mw**4/s*cf*(-1d0/16*mtp**2*t+1d0/16*mtp**4)
     & +propwt*propwtc*log(mbt**2/s)*(s-mtp**2)/(s-mbt**2)/pi**2*alphas*
     & gf**2*mw**4*cf*(-3d0/8*t-1d0/16*mtp**2)
     ...
     & +log(mdn**2/s)*log(1-mbt**2/s)*born/pi*alphas*cf*(1)
     & +log(mup**2/s)*born/pi*alphas*cf*(-3d0/4)
     & +log(mup**2/s)*log(1-mtp**2/s)*born/pi*alphas*cf*(1)
