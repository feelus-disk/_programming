...
************************************************************************
* File (cc_si_1413_2019.f) is created on Tue Aug  9 22:36:49 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_si_1413_2019) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_si_1413_2019 (s,t,u,sigma)
      implicit none!
      ...
      real*8 sqrtpxscta,isqrtpxscta,pxscta
      real*8 costhtn,sinthtn
      real*8 kappaw
      ...
      sqrtpxscta = sqrt(abs(s-mta**2))
      isqrtpxscta = 1d0/sqrtpxscta
      pxscta = (sqrtpxscta)**2
      costhtn = -cosf
      sinthtn = sinf
     ...
     & 0d0
      ...
      amp(1,2,2,1) =
     & +chiws*costhtn*1d0/sqrt(s)*sqrtpxscta*ffll*(-1)
     & +chiws*1d0/sqrt(s)*sqrtpxscta*ffll*(-1)

      amp(1,2,2,2) =
     & +chiws*sinthtn*sqrtpxscta*ffll*(-mta/s)
     & +chiws*sinthtn*sqrtpxscta*ffrd*(-1+mta**2/s)
