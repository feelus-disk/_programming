...
************************************************************************
* File (cc-qcd_ha_23_13__14_20_19.f) is created on Tue Aug  9 23:04:56 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_23_13__14_20_19) to calculate
* differential cross-section of the gluon induced
* g + up -> dn + ta^+ + tn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_23_13__14_20_19 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & 1d0/16*p1p3*p2p4*mdn**2*mta**2/s**2-1d0/16*p2p4*p3p5*mdn**2*mta**
     & 2/s**2)
     ...
     & d0/16*p1p2*p2p4*p3p5*mta**2/s**3+1d0/32*p1p3*p1p4*mta**2/s**2+1d0
     & /32*p1p3*p2p4*mta**2/s**2-1d0/32*p2p4*p3p5*mta**2/s**2)
     ...
     & 1p3*p2p4*mta**2/s**3-1d0/32*p1p3*p4p5*mta**2/s**3-1d0/32*p2p3*p2p
     & 4*mta**2/s**3)
