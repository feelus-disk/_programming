...
************************************************************************
* File (cc_si_1314_1516.f) is created on Tue Aug  9 22:36:20 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_si_1314_1516) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_si_1314_1516 (s,t,u,sigma)
      implicit none!
      ...
      real*8 sqrtpxsmoc,isqrtpxsmoc,pxsmoc
      ...
      sqrtpxsmoc = sqrt(abs(s-mmo**2))
      isqrtpxsmoc = 1d0/sqrtpxsmoc
      pxsmoc = (sqrtpxsmoc)**2
      costhmo = -cosf
      sinthmo = sinf
      ...
      nsig = pi*alpha**2*conhc/s*(1d0-mmo**2/s)/3
     ...
     & 0d0
      ...
      amp(1,2,1,1) =
     & +chiws*sinthmo*sqrtpxsmoc*ffll*(-mmo/s)
     & +chiws*sinthmo*sqrtpxsmoc*ffld*(-1+mmo**2/s)

      amp(1,2,1,2) =
     & 0d0

      amp(1,2,2,1) =
     & +chiws*costhmo*1d0/sqrt(s)*sqrtpxsmoc*ffll*(-1)
     & +chiws*1d0/sqrt(s)*sqrtpxsmoc*ffll*(-1)
