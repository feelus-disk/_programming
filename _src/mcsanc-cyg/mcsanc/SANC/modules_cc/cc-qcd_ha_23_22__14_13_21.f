...
************************************************************************
* File (cc-qcd_ha_23_22__14_13_21.f) is created on Mon Mar 26 11:57:08 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_23_22__14_13_21) to calculate
* differential cross-section of the gluon induced
* g + bt -> dn + anti-up + tp process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_23_22__14_13_21 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
