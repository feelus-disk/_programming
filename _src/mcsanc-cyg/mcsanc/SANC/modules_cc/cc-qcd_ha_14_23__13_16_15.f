...
************************************************************************
* File (cc-qcd_ha_14_23__13_16_15.f) is created on Tue Aug  9 23:04:53 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_14_23__13_16_15) to calculate
* differential cross-section of the gluon induced
* anti-dn + g -> anti-up + mo^+ + mn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_14_23__13_16_15 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & 1d0/16*p1p3*p2p4*mup**2*mmo**2/s**2-1d0/16*p1p3*p4p5*mup**2*mmo**
     & 2/s**2)
     ...
     & d0/16*p1p2*p2p4*p3p5*mmo**2/s**3+1d0/32*p1p3*p2p4*mmo**2/s**2-1d0
     & /32*p1p3*p4p5*mmo**2/s**2+1d0/32*p2p3*p2p4*mmo**2/s**2)
     ...
     & 1p3*p1p4*mmo**2/s**3-1d0/32*p1p3*p2p4*mmo**2/s**3-1d0/32*p2p4*p3p
     & 5*mmo**2/s**3)
