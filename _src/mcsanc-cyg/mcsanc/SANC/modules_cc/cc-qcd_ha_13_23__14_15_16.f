...
************************************************************************
* File (cc-qcd_ha_13_23__14_15_16.f) is created on Tue Aug  9 23:04:51 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_13_23__14_15_16) to calculate
* differential cross-section of the gluon induced
* anti-up + g -> anti-dn + mn + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_13_23__14_15_16 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
     ...
     & 1d0/16*p1p3*p2p4*mdn**2*mmo**2/s**2-1d0/16*p1p3*p4p5*mdn**2*mmo**
     & 2/s**2)
