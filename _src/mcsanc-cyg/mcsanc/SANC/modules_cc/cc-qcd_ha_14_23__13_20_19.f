...
************************************************************************
* File (cc-qcd_ha_14_23__13_20_19.f) is created on Tue Aug  9 23:04:55 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_14_23__13_20_19) to calculate
* differential cross-section of the gluon induced
* anti-dn + g -> anti-up + ta^+ + tn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_14_23__13_20_19 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & costh5/s**2)
      ...
      hard=
     & +iz2up**2*chiwspr*chiwsprc/pi*alpha**2*alphas/spr**3*(s-spr)*cf*(
     & 1d0/16*p1p3*p2p4*mup**2*mta**2/s**2-1d0/16*p1p3*p4p5*mup**2*mta**
     & 2/s**2)
     & +iz2up**2*chiwspr*chiwsprc/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(
     & -1d0/16*p1p3*p2p4*mup**2/s**2+1d0/16*p1p3*p4p5*mup**2/s**2)
     & +iz2up*chiwspr*chiwsprc/pi*alpha**2*alphas/spr**3*(s-spr)*cf*(1d0
     ...
     & +iz2up*chiwspr*chiwsprc/pi*alpha**2*alphas/spr**2*(s-spr)*cf*(-1d
