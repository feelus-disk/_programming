...
************************************************************************
* File (cc_ha_1314_1920.f) is created on Tue Aug  9 22:37:48 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_ha_1314_1920) to calculate differential
* hard photon Bremsstrahlung for the anti-up + dn -> tn + ta^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_1314_1920 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
      ...
      real*8 iz1up,iz2dn,iz3ta,iz4tn
     ...
     & +1d0/2*mdn**2/s-1d0/2*mup**2/s-1d0/2*costh5*sqrtlsupdn/s)
      ...
      iz3ta=
     & +1d0/(mta**2/spr+1d0/4*sinth3**2-1d0/2*sinth3**2*mta**2/spr+1d0/4
     & *sinth3**2*mta**4/spr**2)/(s-spr)*(1d0/2+1d0/2*mta**2/spr+1d0/2*c
     & osth3-1d0/2*costh3*mta**2/spr)
     ...
     & /s**2/spr**2)
     & +iz1up**2*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3*qu
     & p**2*mup**2*mta**2*(s-spr)*(1d0/6*p1p3*p2p4/s**2/spr**3-1d0/6*p2p
     & 4*p3p5/s**2/spr**3)
     ...
     & +iz1up*iz2dn*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3
     & *qup*mta**2*(s-spr)*(1d0/6*p1p3*p2p4/s/spr**3-1d0/12*p1p3*p4p5/s/
     & spr**3-1d0/12*p2p4*p3p5/s/spr**3)
     & +iz1up*iz2dn*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3
     & *qup**2*(s-spr)*(1d0/6*p1p3*p2p4/s/spr**2-1d0/12*p1p3*p4p5/s/spr*
     & *2-1d0/12*p2p4*p3p5/s/spr**2)
     & +iz1up*iz2dn*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3
     & *qup**2*mta**2*(s-spr)*(-1d0/6*p1p3*p2p4/s/spr**3+1d0/12*p1p3*p4p
     ...
     & +iz1up*chiwspr*chiwsprc/pi*alpha**3*qup*mta**2*(-1d0/6*p1p3*p2p4/
     ...
     & 2/spr**2)
     & +iz1up*chiwspr*chiwsprc/pi*alpha**3*qup**2*mta**2*(s-spr)*(-1d0/1
     ...
     & /s**2/spr**2)
     & +iz2dn**2*theta_hard(s,spr,omega)*chiwspr*chiwsprc/pi*alpha**3*qd
     & n**2*mdn**2*mta**2*(s-spr)*(1d0/6*p1p3*p2p4/s**2/spr**3-1d0/6*p1p
     & 3*p4p5/s**2/spr**3)
     & +iz2dn*chiwspr*chiwsprc/pi*alpha**3*qdn*(-1d0/6*p1p3*p2p4/s/spr**
     & 2+1d0/12*p1p3*p4p5/s/spr**2+1d0/12*p2p4*p3p5/s/spr**2)
     & +iz2dn*chiwspr*chiwsprc/pi*alpha**3*qdn*mta**2*(1d0/6*p1p3*p2p4/s
     ...
     & *2/spr**2)
     & +iz2dn*chiwspr*chiwsprc/pi*alpha**3*qdn**2*mta**2*(s-spr)*(1d0/12
     ...
     & 4/s**2/spr**2)
     & +chiwspr*chiwsprc/pi*alpha**3*qdn*mta**2*(1d0/12*p1p3*p2p4/s**2/s
     & pr**3-1d0/12*p1p3*p4p5/s**2/spr**3-1d0/12*p1p3/s**2/spr**2-1d0/12
     & *p2p3*p2p4/s**2/spr**3)
     & +chiwspr*chiwsprc/pi*alpha**3*qdn*mta**4*(1d0/24*p1p3/s**2/spr**3
     & )
     & +chiwspr*chiwsprc/pi*alpha**3*qup*(-1d0/12*p1p3*p1p4/s**2/spr**2+
     & 1d0/12*p1p3*p2p4/s**2/spr**2-1d0/12*p2p4*p3p5/s**2/spr**2-1d0/24*
     & p2p4/s**2/spr)
     & +chiwspr*chiwsprc/pi*alpha**3*qup*mta**2*(1d0/12*p1p3*p1p4/s**2/s
     & pr**3-1d0/12*p1p3*p2p4/s**2/spr**3+1d0/12*p2p4*p3p5/s**2/spr**3)
     & +chiwspr*chiwsprc/pi*alpha**3*qup*mta**4*(1d0/24*p2p4/s**2/spr**3
     & )

      hardfsr=
     & +iz3ta**2*theta_hard(s,spr,omega)*chiws*chiwsc/pi*alpha**3*qta*mt
     & a**2*(s-spr)*(1d0/6*p1p3*p2p4/s**4+1d0/6*p1p5*p2p4/s**4)
     & +iz3ta**2*theta_hard(s,spr,omega)*chiws*chiwsc/pi*alpha**3*qta*mt
     & a**4*(s-spr)*(-1d0/6*p1p3*p2p4/s**4/spr-1d0/6*p1p5*p2p4/s**4/spr)
     & 
     & +iz3ta*chiws*chiwsc/pi*alpha**3*qta*(-1d0/6*p1p3*p2p4/s**4*spr-1d
     & 0/12*p1p3*p2p5/s**4*spr-1d0/12*p1p5*p2p4/s**4*spr)
     & +iz3ta*chiws*chiwsc/pi*alpha**3*qta*(s-spr)*(1d0/12*p1p3*p2p3/s**
     & 4-1d0/12*p1p3*p2p4/s**4-1d0/12*p1p5*p2p4/s**4)
     & +iz3ta*chiws*chiwsc/pi*alpha**3*qta*mta**2*(1d0/6*p1p3*p2p5/s**4-
     & 1d0/6*p1p5*p2p4/s**4)
     & +iz3ta*chiws*chiwsc/pi*alpha**3*qta*mta**2*(s-spr)*(-1d0/12*p1p3*
     & p2p3/s**4/spr+1d0/12*p1p3*p2p4/s**4/spr+1d0/12*p1p5*p2p4/s**4/spr
     & )
     & +iz3ta*chiws*chiwsc/pi*alpha**3*qta*mta**4*(1d0/6*p1p3*p2p4/s**4/
     ...
     & /s**3/spr)
     & +chiws*chiwsc/pi*alpha**3*mta**4/(s-spr)*(-1d0/12*p1p3*p2p5/s**4/
     & spr+1d0/12*p1p5*p2p4/s**4/spr)
     & +chiws*chiwsc/pi*alpha**3*qta*(-1d0/12*p1p3*p2p3/s**4-1d0/12*p1p3
     & *p2p4/s**4+1d0/12*p1p5*p2p4/s**4-1d0/24*p2p4/s**3)
     & +chiws*chiwsc/pi*alpha**3*qta*mta**2*(1d0/12*p1p3*p2p3/s**4/spr+1
     ...
     & +chichicwswspr/pi*alpha**3*qta*(1d0/24*p1p3*p2p3/s**3/spr+1d0/24*
     & p1p3*p2p4/s**3/spr-1d0/24*p1p5*p2p4/s**3/spr+1d0/48*p2p4/s**2/spr
     & )
     & +chichicwswspr/pi*alpha**3*qta*mta**2*(-1d0/24*p1p3*p2p3/s**3/spr
     ...
     & +chichicwswspr/pi*alpha**3*qdn*mta**2*(-1d0/24*p1p3*p2p4/s**3/spr
     & **2+1d0/24*p1p3*p4p5/s**3/spr**2+1d0/24*p1p3/s**3/spr+1d0/24*p2p3
     & *p2p4/s**3/spr**2)
     & +chichicwswspr/pi*alpha**3*qdn*mta**4*(-1d0/48*p1p3/s**3/spr**2)
     & +chichicwswspr/pi*alpha**3*qup*(1d0/24*p1p3*p1p4/s**3/spr-1d0/24*
     & p1p3*p2p4/s**3/spr+1d0/24*p2p4*p3p5/s**3/spr+1d0/48*p2p4/s**3)
     & +chichicwswspr/pi*alpha**3*qup*mta**2*(-1d0/24*p1p3*p1p4/s**3/spr
     & **2+1d0/24*p1p3*p2p4/s**3/spr**2-1d0/24*p2p4*p3p5/s**3/spr**2)
     & +chichicwswspr/pi*alpha**3*qup*mta**4*(-1d0/48*p2p4/s**3/spr**2)
     & +chichicwswspr/pi*alpha**3*qup*qta*(s-spr)*(-1d0/24*p2p4/s**3/spr
     & )
     & +chichicwswspr/pi*alpha**3*qup*qta*mta**2*(s-spr)*(1d0/24*p2p4/s*
     & *3/spr**2)
     ...
     & +chichicwswspr*iz1up/pi*alpha**3*qup*mta**2*(1d0/12*p1p3*p2p4/s**
     & 2/spr**2-1d0/24*p1p3*p4p5/s**2/spr**2-1d0/24*p2p4*p3p5/s**2/spr**
     & 2)
     & +chichicwswspr*iz1up/pi*alpha**3*qup*mta**2*(s-spr)*(1d0/24*p1p3*
     & p1p4/s**3/spr**2-1d0/24*p1p3*p2p4/s**3/spr**2)
     & +chichicwswspr*iz1up/pi*alpha**3*qup*qta*(s-spr)*(1d0/12*p1p3*p2p
     & 4/s**3/spr)
     & +chichicwswspr*iz1up/pi*alpha**3*qup*qta*mta**2*(s-spr)*(-1d0/12*
     & p1p3*p2p4/s**3/spr**2)
     & +chichicwswspr*iz1up*iz3ta*theta_hard(s,spr,omega)/pi*alpha**3*qu
     & p*qta*(s-spr)*(1d0/6*p1p3**2*p2p4/s**3/spr)
     & +chichicwswspr*iz1up*iz3ta*theta_hard(s,spr,omega)/pi*alpha**3*qu
     & p*qta*mta**2*(s-spr)*(-1d0/6*p1p3**2*p2p4/s**3/spr**2)
     ...
     & +chichicwswspr*iz2dn/pi*alpha**3*qdn*mta**2*(-1d0/12*p1p3*p2p4/s*
     & *2/spr**2+1d0/24*p1p3*p4p5/s**2/spr**2+1d0/24*p2p4*p3p5/s**2/spr*
     & *2)
     & +chichicwswspr*iz2dn/pi*alpha**3*qdn*mta**2*(s-spr)*(1d0/24*p1p3*
     & p2p4/s**3/spr**2-1d0/24*p2p3*p2p4/s**3/spr**2)
     & +chichicwswspr*iz2dn/pi*alpha**3*qdn*qta*(s-spr)*(1d0/24*p1p3*p2p
     & 3/s**3/spr-1d0/24*p1p3*p2p4/s**3/spr+1d0/48*p2p4/s**2/spr)
     & +chichicwswspr*iz2dn/pi*alpha**3*qdn*qta*mta**2*(s-spr)*(-1d0/24*
     & p1p3*p2p3/s**3/spr**2+1d0/24*p1p3*p2p4/s**3/spr**2-1d0/48*p2p4/s*
     & *2/spr**2)
     & +chichicwswspr*iz2dn*iz3ta*theta_hard(s,spr,omega)/pi*alpha**3*qd
     & n*qta*(s-spr)*(-1d0/6*p1p3*p2p3*p2p4/s**3/spr)
     & +chichicwswspr*iz2dn*iz3ta*theta_hard(s,spr,omega)/pi*alpha**3*qd
     & n*qta*(s-spr)**2*(-1d0/24*p1p3*p2p3/s**3/spr+1d0/24*p2p3*p2p4/s**
     & 3/spr)
     & +chichicwswspr*iz2dn*iz3ta*theta_hard(s,spr,omega)/pi*alpha**3*qd
     & n*qta*mta**2*(s-spr)*(1d0/6*p1p3*p2p3*p2p4/s**3/spr**2)
     & +chichicwswspr*iz2dn*iz3ta*theta_hard(s,spr,omega)/pi*alpha**3*qd
     & n*qta*mta**2*(s-spr)**2*(1d0/24*p1p3*p2p3/s**3/spr**2-1d0/24*p2p3
     & *p2p4/s**3/spr**2)
     & +chichicwswspr*iz3ta/pi*alpha**3*qta*(1d0/12*p1p3*p2p4/s**3+1d0/2
     & 4*p1p3*p2p5/s**3+1d0/24*p1p5*p2p4/s**3)
     & +chichicwswspr*iz3ta/pi*alpha**3*qta*(s-spr)*(-1d0/24*p1p3*p2p3/s
     & **3/spr+1d0/24*p1p3*p2p4/s**3/spr)
     & +chichicwswspr*iz3ta/pi*alpha**3*qta*mta**2*(-1d0/12*p1p3*p2p5/s*
     & *3/spr+1d0/12*p1p5*p2p4/s**3/spr)
     & +chichicwswspr*iz3ta/pi*alpha**3*qta*mta**2*(s-spr)*(1d0/24*p1p3*
     & p2p3/s**3/spr**2-1d0/24*p1p3*p2p4/s**3/spr**2)
     & +chichicwswspr*iz3ta/pi*alpha**3*qta*mta**4*(-1d0/12*p1p3*p2p4/s*
     & *3/spr**2+1d0/24*p1p3*p2p5/s**3/spr**2-1d0/8*p1p5*p2p4/s**3/spr**
     & 2)
     & +chichicwswspr*iz3ta/pi*alpha**3*qdn*qta*(s-spr)*(1d0/24*p1p3*p2p
     & 4/s**3/spr-1d0/48*p1p3/s**3-1d0/24*p2p3*p2p4/s**3/spr)
     & +chichicwswspr*iz3ta/pi*alpha**3*qdn*qta*mta**2*(s-spr)*(-1d0/24*
     & p1p3*p2p4/s**3/spr**2+1d0/24*p1p3/s**3/spr+1d0/24*p2p3*p2p4/s**3/
     & spr**2)
     & +chichicwswspr*iz3ta/pi*alpha**3*qdn*qta*mta**4*(s-spr)*(-1d0/48*
     & p1p3/s**3/spr**2)
     & +chichicwswspr*iz3ta/pi*alpha**3*qup*qta*(s-spr)*(-1d0/12*p1p3*p2
     & p4/s**3/spr)
     & +chichicwswspr*iz3ta/pi*alpha**3*qup*qta*mta**2*(s-spr)*(1d0/12*p
     & 1p3*p2p4/s**3/spr**2+1d0/24*p2p4/s**3/spr)
     & +chichicwswspr*iz3ta/pi*alpha**3*qup*qta*mta**4*(s-spr)*(-1d0/24*
     & p2p4/s**3/spr**2)
