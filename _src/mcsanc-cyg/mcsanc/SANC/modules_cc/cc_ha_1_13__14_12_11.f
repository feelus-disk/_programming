...
************************************************************************
* File (cc_ha_1_13__14_12_11.f) is created on Mon Aug 26 16:37:35 MSK 2013.
************************************************************************
* This is the FORTRAN module (cc_ha_1_13__14_12_11) to calculate
* differential cross-section of the photon induced
* a + up -> dn + el^+ + en process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_1_13__14_12_11 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
