...
************************************************************************
* File (cc_si_1413_2221.f) is created on Tue Aug  9 22:47:21 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_si_1413_2221) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_si_1413_2221 (s,t,u,sigma)
      implicit none!
      ...
      real*8 sqrtpxstpc,isqrtpxstpc,pxstpc
      real*8 costhtp,sinthtp
      real*8 kappaw
      ...
      sqrtpxstpc = sqrt(abs(s-mtp**2))
      isqrtpxstpc = 1d0/sqrtpxstpc
      pxstpc = (sqrtpxstpc)**2
      costhtp = cosf
      sinthtp = sinf
     ...
     & 0d0
      ...
      amp(1,2,2,2) =
     & +chiwspr*sinthtp*isqrtpxstpc*ffll*(-1d0/2*mtp*s+1d0/2*mtp**3)
     & +chiwspr*sinthtp*isqrtpxstpc*fflr*(-1d0/2*mtp*s+1d0/2*mtp**3)
     & +chiwspr*sinthtp*sqrtpxstpc*ffll*(1d0/2*mtp)
     & +chiwspr*sinthtp*sqrtpxstpc*ffrd*(-s+mtp**2)
     & +chiwspr*sinthtp*sqrtpxstpc*fflr*(-1d0/2*mtp)

      amp(1,2,2,1) =
     & +chiwspr*sqrt(s)*sqrtpxstpc*ffll*(-1d0/2-1d0/2*costhtp)
     & +chiwspr*sqrt(s)*sqrtpxstpc*fflr*(1d0/2+1d0/2*costhtp)
     & +chiwspr*1d0/sqrt(s)*isqrtpxstpc*ffll*(-1d0/2*mtp**2*s+1d0/2*mtp*
     & *4-1d0/2*costhtp*mtp**2*s+1d0/2*costhtp*mtp**4)
     & +chiwspr*1d0/sqrt(s)*isqrtpxstpc*fflr*(-1d0/2*mtp**2*s+1d0/2*mtp*
     & *4-1d0/2*costhtp*mtp**2*s+1d0/2*costhtp*mtp**4)
     & +chiwspr*1d0/sqrt(s)*sqrtpxstpc*ffll*(-1d0/2*s+1d0/2*mtp**2-1d0/2
     & *costhtp*s+1d0/2*costhtp*mtp**2)
     & +chiwspr*1d0/sqrt(s)*sqrtpxstpc*fflr*(-1d0/2*s+1d0/2*mtp**2-1d0/2
     & *costhtp*s+1d0/2*costhtp*mtp**2)
     ...
     & +chiwspr*sinthtp*isqrtpxstpc*fflr*(-1d0/2*mtp*s+1d0/2*mtp**3)
     & +chiwspr*sinthtp*sqrtpxstpc*ffll*(-1d0/2*mtp)
     & +chiwspr*sinthtp*sqrtpxstpc*ffld*(-s+mtp**2)
     & +chiwspr*sinthtp*sqrtpxstpc*fflr*(1d0/2*mtp)
