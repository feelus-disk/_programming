...
************************************************************************
* File (cc-qcd_br_14_23__13_20_19.f) is created on Tue Aug  9 23:04:48 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_14_23__13_20_19_1spr) to calculate
* the gluon induced anti-dn + g -> anti-up + ta^+ + tn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_14_23__13_20_19_1spr (s,spr,hard)
      implicit none!
