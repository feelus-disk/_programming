...
************************************************************************
* File (cc-qcd_ha_23_14__13_19_20.f) is created on Tue Aug  9 23:04:55 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_23_14__13_19_20) to calculate
* differential cross-section of the gluon induced
* g + dn -> up + tn + ta^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_23_14__13_19_20 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
     ...
     & 1d0/16*p1p3*p2p4*mup**2*mta**2/s**2-1d0/16*p2p4*p3p5*mup**2*mta**
     & 2/s**2)
