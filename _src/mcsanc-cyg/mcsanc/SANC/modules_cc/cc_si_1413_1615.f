...
************************************************************************
* File (cc_si_1413_1615.f) is created on Tue Aug  9 22:36:41 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_si_1413_1615) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_si_1413_1615 (s,t,u,sigma)
      implicit none!
      ...
      real*8 sqrtpxscmo,isqrtpxscmo,pxscmo
      real*8 costhmn,sinthmn
      real*8 kappaw
      ...
      sqrtpxscmo = sqrt(abs(s-mmo**2))
      isqrtpxscmo = 1d0/sqrtpxscmo
      pxscmo = (sqrtpxscmo)**2
      costhmn = -cosf
      sinthmn = sinf
     ...
     & 0d0
      ...
      amp(1,2,2,1) =
     & +chiws*costhmn*1d0/sqrt(s)*sqrtpxscmo*ffll*(-1)
     & +chiws*1d0/sqrt(s)*sqrtpxscmo*ffll*(-1)

      amp(1,2,2,2) =
     & +chiws*sinthmn*sqrtpxscmo*ffll*(-mmo/s)
     & +chiws*sinthmn*sqrtpxscmo*ffrd*(-1+mmo**2/s)
