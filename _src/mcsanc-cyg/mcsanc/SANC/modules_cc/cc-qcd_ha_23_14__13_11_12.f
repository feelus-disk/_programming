...
************************************************************************
* File (cc-qcd_ha_23_14__13_11_12.f) is created on Tue Aug  9 23:04:50 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_23_14__13_11_12) to calculate
* differential cross-section of the gluon induced
* g + dn -> up + en + el^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_23_14__13_11_12 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
