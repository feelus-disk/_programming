...
************************************************************************
* File (cc_br_1314_34.f) created on Thu Jan 19 01:32:26 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_bo_1314_34) to calculate EW
* integrated Born cross section for the anti-up + dn -> W^- + H   process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_bo_1314_34 (s,born)
      implicit none!
...
************************************************************************
* This is the FORTRAN module (cc_br_1314_34) to calculate EW Born
* cross section and soft photon Bremsstrahlung
* for the anti-up + dn -> W^- + H   process.
*
* It is produced by s2n package of SANC (v1.10) Project.
* Copyright (C), SANC Project Team, 2002-2012.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_br_1314_34 (qs,ts,us,born,soft,hard)
      implicit none!
      include 's2n_declare.h'
