...
************************************************************************
* File (cc_ha_13_1__14_15_16.f) is created on Mon Aug 26 16:37:49 MSK 2013.
************************************************************************
* This is the FORTRAN module (cc_ha_13_1__14_15_16) to calculate
* differential cross-section of the photon induced
* anti-up + a -> anti-dn + mn + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_13_1__14_15_16 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
