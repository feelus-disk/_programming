...
************************************************************************
* File (cc_ha_1_14__13_11_12.f) is created on Mon Aug 26 16:37:40 MSK 2013.
************************************************************************
* This is the FORTRAN module (cc_ha_1_14__13_11_12) to calculate
* differential cross-section of the photon induced
* a + dn -> up + en + el^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_1_14__13_11_12 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
