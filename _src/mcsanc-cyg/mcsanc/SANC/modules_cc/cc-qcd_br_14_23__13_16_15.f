...
************************************************************************
* File (cc-qcd_br_14_23__13_16_15.f) is created on Tue Aug  9 23:04:45 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_14_23__13_16_15_1spr) to calculate
* the gluon induced anti-dn + g -> anti-up + mo^+ + mn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_14_23__13_16_15_1spr (s,spr,hard)
      implicit none!
