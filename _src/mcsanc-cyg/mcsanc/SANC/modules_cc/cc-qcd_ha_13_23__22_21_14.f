...
************************************************************************
* File (cc-qcd_ha_13_23__22_21_14.f) is created on Mon Mar 26 11:57:05 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_13_23__22_21_14) to calculate
* differential cross-section of the gluon induced
* anti-up + g -> bt + anti-tp + anti-dn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_13_23__22_21_14 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
     ...
     & d0/8*mtp**2*mbt**2/spr
      ...
      iz1bt=
     & +1d0/(1-mup**2/s)**2*1d0/(1d0/4*sqrtlsbtspr**2*1d0/(1-mup**2/s)**
     & 2*sinth5**2-1d0/2*sqrtlsbtspr**2*1d0/(1-mup**2/s)**2*sinth5**2*mu
     & p**2/s+1d0/4*sqrtlsbtspr**2*1d0/(1-mup**2/s)**2*sinth5**2*mup**4/
     & s**2+1d0/(1-mup**2/s)**2*mbt**2*s-2*1d0/(1-mup**2/s)**2*mup**2*mb
     & t**2+1d0/(1-mup**2/s)**2*mup**4*mbt**2/s)*(-1d0/2*spr+1d0/2*s+1d0
     & /2*mbt**2+1d0/2*mup**2/s*spr-1d0/2*mup**2-1d0/2*mup**2*mbt**2/s+1
     & d0/2*sqrtlsbtspr*costh5-1d0/2*sqrtlsbtspr*costh5*mup**2/s)
     ...
     & has*gf**2*mw**4*mbt**2/s**2/spr*cf*(-3d0/32*p1p2*p3p4+3d0/32*p2p5
     & *p3p4)
     & +iz1bt*iz4tp*sqrtlsbtspr*propwp2p3*propcwp2p3*(spr-mtp**2)/pi**3*
     & alphas*gf**2*mw**4/s**2/spr*cf*(-3d0/16*p1p2*p1p4*p3p4+3d0/32*p1p
     & 2*p1p4*p3p5+3d0/32*p1p4*p2p5*p3p4)
     & +iz1bt*sqrtlsbtspr*propwp2p3*propcwp2p3*(spr-mtp**2)/pi**3*alphas
     & *gf**2*mw**4/s**2/spr*cf*(3d0/64*p1p2*p1p3-3d0/64*p1p2*p3p4+3d0/6
     & 4*p2p5*p3p4)
     & +iz4tp**2*sqrtlsbtspr*propwp2p3*propcwp2p3*(spr-mtp**2)/pi**3*alp
     & has*gf**2*mw**4*mtp**2/s**2/spr*cf*(-3d0/32*p1p2*p3p4+3d0/32*p1p2
     & *p3p5)
     & +iz4tp*sqrtlsbtspr*propwp2p3*propcwp2p3*(spr-mtp**2)/pi**3*alphas
     & *gf**2*mw**4/s**2/spr*cf*(-3d0/64*p1p2*p3p4+3d0/64*p1p2*p3p5+3d0/
     & 64*p2p4*p3p4)
