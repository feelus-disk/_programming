...
************************************************************************
* File (cc_si_1314_1112.f) is created on Tue Aug  9 22:36:12 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_si_1314_1112) to calculate EW
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_si_1314_1112 (s,t,u,sigma)
      implicit none!
     ...
     & 0d0
      ...
      amp(1,2,1,1) =
     & +chiws*sinthel*ffld*(-sqrt(s))

      amp(1,2,1,2) =
     & 0d0

      amp(1,2,2,1) =
     & +chiws*costhel*ffll*(-1)
     & +chiws*ffll*(-1)
