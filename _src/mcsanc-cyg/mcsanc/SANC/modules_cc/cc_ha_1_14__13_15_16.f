...
************************************************************************
* File (cc_ha_1_14__13_15_16.f) is created on Mon Aug 26 16:37:51 MSK 2013.
************************************************************************
* This is the FORTRAN module (cc_ha_1_14__13_15_16) to calculate
* differential cross-section of the photon induced
* a + dn -> up + mn + mo^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_1_14__13_15_16 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
