...
************************************************************************
* File (cc_br_1413_2019.f) is created on Tue Aug  9 22:37:31 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_bo_1413_2019) to calculate EW
* integrated Born cross section for the anti-dn + up -> ta^+ + tn process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_bo_1413_2019 (s,born)
      implicit none!
...
************************************************************************
* This is the FORTRAN module (cc_br_1413_2019) to calculate EW Born
* cross section and soft photon Bremsstrahlung
* for the anti-dn + up -> ta^+ + tn process.
*
* It is produced by s2n package of SANC (v1.10) Project.
* Copyright (C), SANC Project Team, 2002-2011.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_br_1413_2019 (qs,ts,us,born,soft,hard)
      implicit none!
      include 's2n_declare.h'

      real*8 softvirtisr,softvirtfsr,softvirtifi
      real*8 ln1sdn,ln1sup,ln1sta
...
************************************************************************
* This is the FORTRAN module (cc_ha_1413_2019_1spr) to calculate hard
* photon Bremsstrahlung for the anti-dn + up -> ta^+ + tn process.
*
* It is produced by s2n package of SANC (v1.10) Project.
* Copyright (C), SANC Project Team, 2002-2011.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_1413_2019_1spr (s,spr,hard)
      implicit none!
      include 's2n_declare.h'

      real*8 ln1sprta,ln1sdn,ln1sup
