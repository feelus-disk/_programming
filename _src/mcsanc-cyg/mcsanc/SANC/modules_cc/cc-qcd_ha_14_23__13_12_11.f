...
************************************************************************
* File (cc-qcd_ha_14_23__13_12_11.f) is created on Tue Aug  9 23:04:50 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_qcd_ha_14_23__13_12_11) to calculate
* differential cross-section of the gluon induced
* anti-dn + g -> anti-up + el^+ + en process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_ha_14_23__13_12_11 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
