...
************************************************************************
* File (cc_ha_1314_1112.f) is created on Tue Aug  9 22:37:39 MSD 2011.
************************************************************************
* This is the FORTRAN module (cc_ha_1314_1112) to calculate differential
* hard photon Bremsstrahlung for the anti-up + dn -> en + el^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_1314_1112 (s,spr,ph3,costh3,costh5,hard)
      implicit none!
      ...
      real*8 iz1up,iz2dn,iz3el,iz4en
     ...
     & +1d0/2*mdn**2/s-1d0/2*mup**2/s-1d0/2*costh5*sqrtlsupdn/s)
      ...
      iz3el=
     & +1d0/(mel**2/spr+1d0/4*sinth3**2-1d0/2*sinth3**2*mel**2/spr+1d0/4
     & *sinth3**2*mel**4/spr**2)/(s-spr)*(1d0/2+1d0/2*mel**2/spr+1d0/2*c
     & osth3-1d0/2*costh3*mel**2/spr)
     ...
     & p2p4/s**2/spr)
      ...
      hardfsr=
     & +iz3el**2*theta_hard(s,spr,omega)*chiws*chiwsc/pi*alpha**3*qel*me
     & l**2*(s-spr)*(1d0/6*p1p3*p2p4/s**4+1d0/6*p1p5*p2p4/s**4)
     & +iz3el*chiws*chiwsc/pi*alpha**3*qel*(-1d0/6*p1p3*p2p4/s**4*spr-1d
     & 0/12*p1p3*p2p5/s**4*spr-1d0/12*p1p5*p2p4/s**4*spr)
     & +iz3el*chiws*chiwsc/pi*alpha**3*qel*(s-spr)*(1d0/12*p1p3*p2p3/s**
     ...
     & +chiws*chiwsc/pi*alpha**3*qel*(-1d0/12*p1p3*p2p3/s**4-1d0/12*p1p3
     ...
     & +chichicwswspr/pi*alpha**3*qel*(1d0/24*p1p3*p2p3/s**3/spr+1d0/24*
     & p1p3*p2p4/s**3/spr-1d0/24*p1p5*p2p4/s**3/spr+1d0/48*p2p4/s**2/spr
     & )
     & +chichicwswspr/pi*alpha**3*qel*qup*(s-spr)*(-1d0/24*p2p4/s**3/spr
     & )
     ...
     & +chichicwswspr*iz1up/pi*alpha**3*qel*qup*(s-spr)*(1d0/12*p1p3*p2p
     & 4/s**3/spr)
     & +chichicwswspr*iz1up*iz3el*theta_hard(s,spr,omega)/pi*alpha**3*qe
     & l*qup*(s-spr)*(1d0/6*p1p3**2*p2p4/s**3/spr)
     ...
     & +chichicwswspr*iz2dn/pi*alpha**3*qel*qdn*(s-spr)*(1d0/24*p1p3*p2p
     & 3/s**3/spr-1d0/24*p1p3*p2p4/s**3/spr+1d0/48*p2p4/s**2/spr)
     & +chichicwswspr*iz2dn*iz3el*theta_hard(s,spr,omega)/pi*alpha**3*qe
     & l*qdn*(s-spr)*(-1d0/6*p1p3*p2p3*p2p4/s**3/spr)
     & +chichicwswspr*iz2dn*iz3el*theta_hard(s,spr,omega)/pi*alpha**3*qe
     & l*qdn*(s-spr)**2*(-1d0/24*p1p3*p2p3/s**3/spr+1d0/24*p2p3*p2p4/s**
     & 3/spr)
     & +chichicwswspr*iz3el/pi*alpha**3*qel*(1d0/12*p1p3*p2p4/s**3+1d0/2
     & 4*p1p3*p2p5/s**3+1d0/24*p1p5*p2p4/s**3)
     & +chichicwswspr*iz3el/pi*alpha**3*qel*(s-spr)*(-1d0/24*p1p3*p2p3/s
     & **3/spr+1d0/24*p1p3*p2p4/s**3/spr)
     & +chichicwswspr*iz3el/pi*alpha**3*qel*qdn*(s-spr)*(1d0/24*p1p3*p2p
     & 4/s**3/spr-1d0/48*p1p3/s**3-1d0/24*p2p3*p2p4/s**3/spr)
     & +chichicwswspr*iz3el/pi*alpha**3*qel*qup*(s-spr)*(-1d0/12*p1p3*p2
     & p4/s**3/spr)
