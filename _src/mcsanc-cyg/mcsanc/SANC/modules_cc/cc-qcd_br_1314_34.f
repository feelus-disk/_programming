...
************************************************************************
* File (cc-qcd_br_1314_34.f) created on Fri Mar 23 13:04:50 MSK 2012.
************************************************************************
* This is the FORTRAN module (cc_qcd_br_1314_34) to calculate QCD soft
* gluon radiation cross section for the anti-up + dn -> W^- + H   process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_qcd_br_1314_34 (qs,ts,us,born,soft,hard)
      implicit none!
