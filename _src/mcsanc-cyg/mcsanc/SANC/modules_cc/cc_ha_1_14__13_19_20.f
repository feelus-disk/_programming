...
************************************************************************
* File (cc_ha_1_14__13_19_20.f) is created on Mon Aug 26 16:38:01 MSK 2013.
************************************************************************
* This is the FORTRAN module (cc_ha_1_14__13_19_20) to calculate
* differential cross-section of the photon induced
* a + dn -> up + tn + ta^- process.
*
...
* E-mail: <sanc@jinr.ru>
************************************************************************
      subroutine cc_ha_1_14__13_19_20 (s,spr,ph4,costh4,costh5,hard)
      implicit none!
