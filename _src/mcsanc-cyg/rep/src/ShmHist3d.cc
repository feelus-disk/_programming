...
sem_wait(_hist_fill_mutex);
  ...
  int thebin0=lower_bound(_bins0,_bins0+_n0bins,x0)-_bins0-1;
  int thebin1=lower_bound(_bins1,_bins1+_n1bins,x1)-_bins1-1;
  int thebin2=lower_bound(_bins2,_bins2+_n2bins,x2)-_bins2-1;
